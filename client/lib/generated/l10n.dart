...
class S {
  ...
  String get serverHostRequired {
    return Intl.message(
      'Server host is required',
      name: 'serverHostRequired',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Is SSL Mode Enabled`
  String get isSSLModeEnabled {
    return Intl.message(
      'SSL Mode',
      name: 'isSSLModeEnabled',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Is SSL Mode Enabled`
  String get isSSLModeEnabledDesc {
    return Intl.message(
      'Is SSL Mode Enabled',
      name: 'isSSLModeEnabledDesc',
      desc: '',
      args: [],
    );
  }
