...
import 'package:client/pages/about.dart' as about;
import 'package:client/pages/home.dart';
import 'package:client/pages/settings_list_item.dart';
...
class SettingsFeedback extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _SettingsLink(
      ...
      onTap: () async {
        final url =
            Uri.parse('https://github.com/flutter/client/issues/new/choose/');
