...
import 'package:client/studies/rally/charts/line_chart.dart';
import 'package:client/studies/rally/charts/pie_chart.dart';
import 'package:client/studies/rally/charts/vertical_fraction_bar.dart';
import 'package:client/studies/rally/colors.dart';
import 'package:client/studies/rally/data.dart';
import 'package:client/studies/rally/formatters.dart';
...
class FinancialEntityCategoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics.fromProperties(
      ...
      // TODO(x): State restoration of FinancialEntityCategoryDetailsPage on mobile is blocked because OpenContainer does not support restorablePush, https://github.com/flutter/client/issues/570.
      child: OpenContainer(
