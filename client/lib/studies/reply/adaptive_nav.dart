...
import 'package:client/studies/reply/app.dart';
import 'package:client/studies/reply/bottom_drawer.dart';
import 'package:client/studies/reply/colors.dart';
import 'package:client/studies/reply/compose_page.dart';
import 'package:client/studies/reply/mailbox_body.dart';
import 'package:client/studies/reply/model/email_model.dart';
import 'package:client/studies/reply/model/email_store.dart';
import 'package:client/studies/reply/profile_avatar.dart';
import 'package:client/studies/reply/search_page.dart';
import 'package:client/studies/reply/waterfall_notched_rectangle.dart';
    ...
    return Selector<EmailStore, bool>(
      ...
      builder: (context, onMailView, child) {
        ...
        if (isDesktop) {
          ...
          // TODO(x): State restoration of compose page on mobile is blocked because OpenContainer does not support restorablePush, https://github.com/flutter/client/issues/570.
