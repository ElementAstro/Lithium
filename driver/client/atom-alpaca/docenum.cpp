...
int DocIntEnum::getEnumValue(std::string_view doc) const {
    ...
    return -1;  // Return -1 if no enum value is found for the given
                // documentation.
}

void DocIntEnum::removeEnum(int value) { enumMap.erase(value); }

void DocIntEnum::clearEnums() { enumMap.clear(); }
