...
public:
    explicit ActionNotImplementedException(const std::string &message)
        : message_(message) {}
...
public:
    explicit AlpacaRequestException(int number, const std::string &message)
...
public:
    explicit DriverException(int number, const std::string &message)
        : number_(number), message_(message) {}
...
public:
    explicit NotConnectedException(const std::string &message)
        : message_(message) {}
...
public:
    explicit ValueNotSetException(const std::string &message)
        : message_(message) {}
