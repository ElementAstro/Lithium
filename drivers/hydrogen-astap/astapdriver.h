...
/**
 * @brief The AstapDriver class is an HYDROGEN driver frontend for astrometry.net
 *
 ...
 * @author Jasem Mutlaq
 */
class AstapDriver : public HYDROGEN::DefaultDevice
{
    public:
        enum
        {
            ASTAP_SETTINGS_BINARY,
            ASTAP_SETTINGS_OPTIONS
        };

        enum
        {
            ASTAP_RESULTS_PIXSCALE,
            ASTAP_RESULTS_ORIENTATION,
            ASTAP_RESULTS_RA,
            ASTAP_RESULTS_DE,
            ASTAP_RESULTS_PARITY
        };
