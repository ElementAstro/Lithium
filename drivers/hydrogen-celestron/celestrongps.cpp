...
{
    setVersion(3, 6); // update libhydrogen/drivers.xml as well
    ...
    HYDROGEN::Logger::getInstance().addDebugLevel("Scope Verbose", "SCOPE");
    ...
    // ISGetProperties in HYDROGEN::Telescope checks for CanGOTO which must be set.
...
bool CelestronGPS::initProperties()
{
    ...
    // HYDROGEN track modes are sidereal, solar and lunar
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    /// Guide Rate; units and min/max as specified in the HYDROGEN Standard Properties SLEW_GUIDE
    /// https://hydrogenlib.org/developers/developer-manual/101-standard-properties.html#h3-telescopes
    //////////////////////////////////////////////////////////////////////////////////////////////////
...
bool CelestronGPS::updateProperties()
{
    if (isConnected())
    {
        ...
        // http://www.hydrogenlib.org/forum/mounts/2208-celestron-avx-mount-and-starsense.html
...
bool CelestronGPS::MoveNS(HYDROGEN_DIR_NS dir, TelescopeMotionCommand command)
{
...
bool CelestronGPS::MoveWE(HYDROGEN_DIR_WE dir, TelescopeMotionCommand command)
{
...
{
    HYDROGEN::Telescope::TelescopePierSide pierSide = PIER_UNKNOWN;
    ...
    if (HasPierSide())
    {
        ...
        if (driver.get_pier_side(&sop))
        {
            ...
            // The Celestron and HYDROGEN pointing states are opposite
            if (sop == 'W')
            {
                pierSide = PIER_EAST;
                psc = 'E';
...
bool CelestronGPS::ISNewNumber(const char *dev, const char *name, double values[], char *names[], int n)
{
    ...
    HYDROGEN::Telescope::ISNewNumber(dev, name, values, names, n);
    return true;
}
...
bool CelestronGPS::ISNewText(const char *dev, const char *name, char **texts, char **names, int n)
{
    ...
    HYDROGEN::Telescope::ISNewText(dev, name, texts, names, n);
    return true;
}
...
// the HYDROGEN overload, expected to set the track rate
...
bool CelestronGPS::savePecData()
{
    ...
    // ~/.hydrogen/pec/yyyy-mm-dd/pecData_hh:mm.log
...
IPState CelestronGPS::MoveRelFocuser(HYDROGEN::FocuserInterface::FocusDirection dir, uint32_t ticks)
{
