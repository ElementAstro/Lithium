...
{
    HYDROGEN::FilterWheel::ISGetProperties(dev);
...
{
    HYDROGEN::FilterWheel::initProperties();
...
{
    HYDROGEN::FilterWheel::updateProperties();
...
bool ManualFilter::ISNewNumber(const char *dev, const char *name, double values[], char *names[], int n)
{
    ...
    return HYDROGEN::FilterWheel::ISNewNumber(dev, name, values, names, n);
}
...
bool ManualFilter::ISNewSwitch(const char *dev, const char *name, ISState *states, char *names[], int n)
{
    ...
    return HYDROGEN::FilterWheel::ISNewSwitch(dev, name, states, names, n);
}
...
{
    HYDROGEN::FilterWheel::saveConfigItems(fp);
