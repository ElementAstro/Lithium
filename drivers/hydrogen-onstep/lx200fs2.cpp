...
{
    if (ParkedStatus != PARKED_NOTPARKED)
        return;
...
{
    if (ParkedStatus != PARKED_NEEDABORT)
        return;
...
{
    if (ParkedStatus != PARKED_NEEDSTOP)
        return;
...
{
    if (ParkedStatus != PARKED_STOPPED)
        return;
...
{
    if (ParkedStatus != UNPARKED_NEEDSLEW)
        return;
