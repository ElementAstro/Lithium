...
class WatchDog : public HYDROGEN::DefaultDevice
{
    public:
        typedef enum
        {
    ...
    private:
        ...
        HYDROGEN::PropertyNumber HeartBeatNP {1};
        ...
        IText SettingsT[4] {};
        enum {HYDROGENSERVER_HOST, HYDROGENSERVER_PORT, SHUTDOWN_SCRIPT};
        ...
        HYDROGEN::Timer m_ClientAlertTimer;
        // Weather timer to trigger shutdown if weather remains ALERT for this many seconds.
        HYDROGEN::Timer m_WeatherAlertTimer;
        // HYDROGEN Port
        uint32_t m_HYDROGENServerPort { 7624 };
        // Weather State
