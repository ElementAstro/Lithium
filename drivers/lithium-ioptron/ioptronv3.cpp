...
bool IOptronV3::initProperties()
{
    ...
    driver->setSimLongLat(LocationN[LOCATION_LONGITUDE].value > 180 ? LocationN[LOCATION_LONGITUDE].value - 360 : LocationN[LOCATION_LONGITUDE].value, LocationN[LOCATION_LATITUDE].value);
