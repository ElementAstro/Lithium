        ...
        double mountDec)
{
    ...
    HYDROGEN::IEquatorialCoordinates RaDec {mountRA, mountDec};
...
bool AlignmentSubsystemForDrivers::SkyToTelescopeEquatorial(double actualRA, double actualDec, double &mountRA,
        double &mountDec)
{
    HYDROGEN::IEquatorialCoordinates eq{0, 0};
        ...
        double mountAz)
{
    ...
    HYDROGEN::IHorizontalCoordinates AltAz {range360(mountAz), range360(mountAlt)};
    AlignmentDatabaseEntry NewEntry;
