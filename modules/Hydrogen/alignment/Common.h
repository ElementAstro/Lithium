...
/// \defgroup AlignmentSubsystem HYDROGEN Alignment Subsystem

namespace HYDROGEN
{
/// \namespace HYDROGEN::AlignmentSubsystem
/// \brief Namespace to encapsulate the HYDROGEN Alignment Subsystem classes.
/// For more information see "HYDROGEN Alignment Subsystem" in "Related Pages" accessible via the banner at the
/// top of this page.
...
/// \note This must match the definitions given to HYDROGEN
enum AlignmentPointSetEnum
{
