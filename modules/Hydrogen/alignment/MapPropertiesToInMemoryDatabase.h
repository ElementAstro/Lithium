 ...
 * \brief An entry in the sync point database is defined by the following HYDROGEN properties
...
class MapPropertiesToInMemoryDatabase : public InMemoryDatabase
{
    public:
        ...
        /// \param[in] pTelescope Pointer to the child HYDROGEN::Telecope class
