...
namespace HYDROGEN
{
     ...
     *
     * Developers need to subclass HYDROGEN::CCD to implement any driver for CCD cameras within HYDROGEN.
     *
     * Data binary transfers are supported using two methods:
     * # HYDROGEN BLOBs: This is the and recommended default configuration.
     * # Websockets: This requires HYDROGEN to be built with websocket support. There is marginal
     * improvement in throughput with Websockets when compared with HYDROGEN base64 BLOB encoding.
     ...
     *
     * HYDROGEN::CCD and HYDROGEN::StreamManager both upload frames asynchrounously in a worker thread.
    ...
    protected:
         ...
         */
        virtual void GuideComplete(HYDROGEN_EQ_AXIS axis) override;
        ...
        char exposureStartTime[MAXHYDROGENNAME];
        ...
        HYDROGEN::Timer m_TemperatureCheckTimer;
        HYDROGEN::ElapsedTimer m_TemperatureElapsedTimer;
         ...
         */
        HYDROGEN::PropertyNumber TemperatureRampNP{2};
        enum
        {
            RAMP_SLOPE,
            RAMP_THRESHOLD
        ...
        HYDROGEN::PropertySwitch CaptureFormatSP{0};

        /// Specifies Driver image encoding format (FITS, Native, JPG, ..etc)
        HYDROGEN::PropertySwitch EncodeFormatSP{3};
        enum
        {
        ...
        HYDROGEN::PropertyNumber ScopeInfoNP{2};
        enum
        {
            FocalLength,
            Aperture
        ...
        HYDROGEN::PropertyText FITSHeaderTP{3};
        enum
        {
            KEYWORD_NAME,
            KEYWORD_VALUE,
    ...
    private:
        ...
        int m_ConfigFastExposureIndex{HYDROGEN_DISABLED};
