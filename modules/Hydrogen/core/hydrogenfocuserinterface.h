...
// Alias
using FI = HYDROGEN::FocuserInterface;
...
namespace HYDROGEN
{
     ...
     * \class FocuserInterface
       ...
       When developing a driver for a fully indepdent focuser device, use HYDROGEN::Focuser directly. To add focus functionality to
       an existing mount or camera driver, subclass HYDROGEN::FocuserInterface. In your driver, then call the necessary focuser interface functions.
       ...
       Implement and overwrite the rest of the virtual functions as needed. HYDROGEN GPhoto driver is a good example to check for an actual implementation
