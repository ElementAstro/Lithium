...
#include "hydrogenproperties_p.h"
...
namespace HYDROGEN
{
    ...
    void Properties::push_back(const HYDROGEN::Property &property)
    {
        D_PTR(Properties);
        d->properties.push_back(property);
    }

    void Properties::push_back(HYDROGEN::Property &&property)
    {
        D_PTR(Properties);
    ...
    HYDROGEN::Properties Properties::operator*()
    {
        return *this;
    }

    const HYDROGEN::Properties Properties::operator*() const
    {
        return *this;
    }
    ...
    Properties::operator std::vector<HYDROGEN::Property *> *()
    {
        D_PTR(Properties);
    ...
    Properties::operator const std::vector<HYDROGEN::Property *> *() const
    {
        D_PTR(const Properties);
        d->propertiesBC.resize(0);
        d->propertiesBC.reserve(d->properties.size());
        for (auto &it : d->properties)
            d->propertiesBC.push_back(const_cast<HYDROGEN::Property *>(&it));
