/*
    ...
    1. raw HYDROGEN encoder (8 bit grayscale and RGB24 color)
...
namespace HYDROGEN
{
    ...
    void EncoderInterface::init(HYDROGEN::DefaultDevice *mainDevice)
    {
    ...
    bool EncoderInterface::setPixelFormat(HYDROGEN_PIXEL_FORMAT pixelFormat, uint8_t pixelDepth)
    {
