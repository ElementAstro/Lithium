...
#pragma warning(push)
///@todo Introduce plattform hydrogenpendent safe functions as macros to fix this
...
int AbstractBaseClientPrivate::deleteDevice(const char *devName, char *errmsg)
{
    ...
    return HYDROGEN_DEVICE_NOT_FOUND;
}
...
void AbstractBaseClient::sendNewProperty(HYDROGEN::Property pp)
{
    D_PTR(AbstractBaseClient);
...
void AbstractBaseClient::sendNewText(HYDROGEN::Property pp)
{
    D_PTR(AbstractBaseClient);
    AutoCNumeric locale;
...
void AbstractBaseClient::sendNewNumber(HYDROGEN::Property pp)
{
    D_PTR(AbstractBaseClient);
    AutoCNumeric locale;
    pp.setState(IPS_BUSY);
...
void AbstractBaseClient::sendNewSwitch(HYDROGEN::Property pp)
{
    D_PTR(AbstractBaseClient);
    pp.setState(IPS_BUSY);
    IUUserIONewSwitch(&d->io, d, pp.getSwitch()->cast());
...
void AbstractBaseClient::sendOneBlob(HYDROGEN::WidgetViewBlob *blob)
{
    D_PTR(AbstractBaseClient);
...
{
    sendOneBlob(HYDROGEN::WidgetViewBlob::cast(bp));
}
