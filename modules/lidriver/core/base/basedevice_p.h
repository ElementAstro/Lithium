...
namespace LITHIUM
{
    ...
    public:
        ...
        int setBLOB(LITHIUM::PropertyBlob propertyBlob, const LITHIUM::LilXmlElement &root, char *errmsg);

        void emitWatchProperty(const LITHIUM::Property &property, bool isNew)
        {
        ...
        void addProperty(const LITHIUM::Property &property)
        {
            {
    ...
    public:
        struct WatchDetails
        {
            std::function<void(LITHIUM::Property)> callback;
    ...
    public:
        ...
        LITHIUM::BaseMediator *mediator{nullptr};
