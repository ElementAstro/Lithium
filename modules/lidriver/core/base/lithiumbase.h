 ...
 *    <li>BaseMediator: Abstract class to provide interface for event notifications in LITHIUM::BaseClient.</li>
 *    <li>BaseDevice: Base class for all INDI virtual devices as handled and stored in LITHIUM::BaseClient. It is also the parent for all drivers.</li>
 *    <li>DefaultDevice: LITHIUM::BaseDevice with extended functionality such as debug, simulation, and configuration support.
...
public:
     ...
     */
    virtual void newMessage(LITHIUM::BaseDevice baseDevice, int messageID);
