...
namespace LITHIUM
{
  ...
  The properties are defined as string constants. To refer to the property in device drivers, use LITHIUM::StandardProperty::PROPERTY_NAME or the shortcut LITHIUM::SP::PROPERTY_NAME.
  ...
  */
  namespace SP
  {
     ...
     * Name | Type | Member | Default | Description
     * ---- | ---- | ------ | ------- | -----------
     * DEVICE_AUTO_SEARCH | SWITCH | LITHIUM_ENABLED | ON | Auto Search ON
     * DEVICE_AUTO_SEARCH | SWITCH | LITHIUM_DISABLED | OFF | Auto Search OFF
     */
     ...
     * Name | Type | Member | Default | Description
     * ---- | ---- | ------ | ------- | -----------
     * DEVICE_LAN_SEARCH | SWITCH | LITHIUM_ENABLED | OFF | LAN Search ON
     * DEVICE_LAN_SEARCH | SWITCH | LITHIUM_DISABLED | ON | LAN Search OFF
     */
