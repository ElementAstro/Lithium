...
namespace LITHIUM
{
    ...
    int WatchDeviceProperty::processXml(const LITHIUM::LilXmlElement &root, char *errmsg, const std::function<ParentDevice()> &constructor)
    {
