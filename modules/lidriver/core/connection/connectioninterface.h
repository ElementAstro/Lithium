 ...
 * @brief Combines all LITHIUM Connection Plugins. Each LITHIUM connection plugin is responsible of managing communications
 * with a specific physical or logical medium (e.g. serial or ethernet).
 */
namespace Connection
{
    /**
     * @brief The Interface class is the base class for all LITHIUM connection plugins.
     *
     ...
     * @see Connection::TCP
     * @see LITHIUM::Telescope utilizes both serial and tcp plugins to communicate with mounts.
     */
    class Interface
    {
    public:
         ...
         * @see LITHIUM::Telescope
         */
        void registerHandshake(std::function<bool()> callback);

    protected:
        Interface(LITHIUM::DefaultDevice *dev, Type type = CONNECTION_NONE);
        virtual ~Interface();
