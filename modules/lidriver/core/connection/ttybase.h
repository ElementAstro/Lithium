...
public:
    ...
    */
     ...
     * @param channel Channel from LITHIUM logger to log to.
     ...
     */
    void setDebug(LITHIUM::Logger::VerbosityLevel channel);
...
private:
    ...
    int m_PortFD{-1};
    bool m_Debug{false};
    LITHIUM::Logger::VerbosityLevel m_DebugChannel{LITHIUM::Logger::DBG_IGNORE};
