...
/**
 * \class LITHIUM::DefaultDevice
 * \brief Class to provide extended functionality for devices in addition
 * to the functionality provided by LITHIUM::BaseDevice. This class should \e only be subclassed by
 * drivers directly as it is linked with main(). Virtual drivers cannot employ LITHIUM::DefaultDevice.
 *
 * LITHIUM::DefaultDevice provides capability to add Debug, Simulation, and Configuration controls.
...
namespace LITHIUM
{
    ...
    public:
         ...
         */
        LITHIUM_DEPRECATED("Use defineProperty(LITHIUM::Property &).")
        ...
        void defineProperty(LITHIUM::Property &property);
        /**
         ...
         */
        bool deleteProperty(LITHIUM::Property &property);
    ...
    public:
         ...
         * \note This function is called by the LITHIUM framework, do not call it directly. See LX200
         ...
         * \note This function is called by the LITHIUM framework, do not call it directly.
        ...
        /**
         * \brief Process a snoop event from LITHIUM server. This function is called when a snooped property is
    ...
    public:
         ...
         */
        void watchDevice(const char *deviceName, const std::function<void(LITHIUM::BaseDevice)> &callback);
    ...
    protected:
         ...
         * @param defineEnabled True to define all dynamic properties in LITHIUM::DefaultDevice own
         ...
         */
        bool loadConfig(LITHIUM::Property &property);
         ...
         */
        bool saveConfig(LITHIUM::Property &property);
        ...
        /**
         * \brief Connect to the device. LITHIUM::DefaultDevice implementation connects to appropriate
