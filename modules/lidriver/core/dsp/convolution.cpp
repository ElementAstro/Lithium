...
namespace DSP
{
    ...
    Convolution::Convolution(LITHIUM::DefaultDevice *dev) : Interface(dev, DSP_CONVOLUTION, "CONVOLUTION", "Convolution")
    {
    ...
    Wavelets::Wavelets(LITHIUM::DefaultDevice *dev) : Interface(dev, DSP_WAVELETS, "WAVELETS", "Wavelets")
    {
        for (int i = 0; i < N_WAVELETS; i++)
        {
            char strname[MAXLITHIUMNAME];
            char strlabel[MAXLITHIUMLABEL];
