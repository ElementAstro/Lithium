...
namespace DSP
{
    /**
     * @namespace DSP
     * @brief The DSP Namespace adds signal processing to LITHIUM drivers. Primarily written for sensors and detectors, it can be used also
    ...
    {
        /**
         * @brief The Interface class is the base class for the DSP plugins of LITHIUM.
         *
         ...
         * @see DSP::Transforms
         * @see DSP::Manager
         * @see LITHIUM::CCD and LITHIUM::SensorInterface utilize the DSP Namespace.
         */
    public:
        /**
         * \struct Type
    ...
    protected:
        ...
        Interface(LITHIUM::DefaultDevice *dev, Type type = DSP_NONE, const char *name = "DSP_PLUGIN",
                  const char *label = "DSP Plugin");
        virtual ~Interface();

        const char *getDeviceName();
        LITHIUM::DefaultDevice *m_Device{nullptr};
    ...
    private:
        char captureExtention[MAXLITHIUMBLOBFMT]{"fits"};
        void *buffer{nullptr};
