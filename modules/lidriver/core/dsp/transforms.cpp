...
namespace DSP
{
    ...
    FourierTransform::FourierTransform(LITHIUM::DefaultDevice *dev) : Interface(dev, DSP_DFT, "DFT", "DFT")
    {
    }
    ...
    InverseFourierTransform::InverseFourierTransform(LITHIUM::DefaultDevice *dev) : Interface(dev, DSP_IDFT, "IDFT", "IDFT")
    {
    ...
    Spectrum::Spectrum(LITHIUM::DefaultDevice *dev) : Interface(dev, DSP_SPECTRUM, "SPECTRUM", "Spectrum")
    {
    }
    ...
    Histogram::Histogram(LITHIUM::DefaultDevice *dev) : Interface(dev, DSP_HISTOGRAM, "HISTOGRAM", "Histogram")
    {
    }
