...
namespace DSP
{
    ...
    {
    public:
        FourierTransform(LITHIUM::DefaultDevice *dev);
    ...
    {
    public:
        InverseFourierTransform(LITHIUM::DefaultDevice *dev);
    ...
    {
    public:
        Spectrum(LITHIUM::DefaultDevice *dev);
        virtual bool processBLOB(uint8_t *out, uint32_t dims, int *sizes, int bits_per_sample) override;
    ...
    {
    public:
        Histogram(LITHIUM::DefaultDevice *dev);
        virtual bool processBLOB(uint8_t *out, uint32_t dims, int *sizes, int bits_per_sample) override;
