 ...
 *
 *  The LITHIUM Common Routine Library provides formatting and serial routines employed by many LITHIUM drivers. Currently, the library is composed of the following sections:
 *
 *  <ul>
 ...
 */
     ...
     *  \note buf must be of length MAXLITHIUMFORMAT at minimum
     */
     ...
     *  \param longitude Longitude in LITHIUM format (0 to 360) increasing eastward.
     ...
     *  \param latitude latitude in LITHIUM format (-90 to +90)
