...
namespace LITHIUM
{
     ...
     *
     * Developers need to subclass LITHIUM::CCD to implement any driver for CCD cameras within LITHIUM.
     *
     * Data binary transfers are supported using two methods:
     * # LITHIUM BLOBs: This is the and recommended default configuration.
     * # Websockets: This requires LITHIUM to be built with websocket support. There is marginal
     * improvement in throughput with Websockets when compared with LITHIUM base64 BLOB encoding.
     ...
     *
     * LITHIUM::CCD and LITHIUM::StreamManager both upload frames asynchrounously in a worker thread.
    ...
    protected:
         ...
         */
        virtual void GuideComplete(LITHIUM_EQ_AXIS axis) override;
        ...
        char exposureStartTime[MAXLITHIUMNAME];
        ...
        LITHIUM::Timer m_TemperatureCheckTimer;
        LITHIUM::ElapsedTimer m_TemperatureElapsedTimer;
         ...
         */
        LITHIUM::PropertyNumber TemperatureRampNP{2};
        enum
        {
            RAMP_SLOPE,
            RAMP_THRESHOLD
        ...
        LITHIUM::PropertySwitch CaptureFormatSP{0};

        /// Specifies Driver image encoding format (FITS, Native, JPG, ..etc)
        LITHIUM::PropertySwitch EncodeFormatSP{3};
        enum
        {
        ...
        LITHIUM::PropertyNumber ScopeInfoNP{2};
        enum
        {
            FocalLength,
            Aperture
        ...
        LITHIUM::PropertyText FITSHeaderTP{3};
        enum
        {
            KEYWORD_NAME,
            KEYWORD_VALUE,
    ...
    private:
        ...
        int m_ConfigFastExposureIndex{LITHIUM_DISABLED};
