                ...
                for (int i = 0; i < JoystickSettingTP.ntp; i++)
                {
                    ...
                    if (tp)
                    {
                        ...
                        if (cType != myType)
                        {
                            ...
                            DEBUGFDEVICE(dev, LITHIUM::Logger::DBG_ERROR, "Cannot change controller type to %s.", texts[i]);
                            return false;
                        }
                    }
                }
