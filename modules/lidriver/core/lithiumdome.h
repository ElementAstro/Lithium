 ...
 * \class LITHIUM::Dome
   ...
   Developers need to subclass LITHIUM::Dome to implement any driver for Domes within LITHIUM.
...
namespace LITHIUM
{
     ...
     protected:
          ...
          LITHIUM::IHorizontalCoordinates mountHoriztonalCoords;
          LITHIUM::IEquatorialCoordinates mountEquatorialCoords;
     ...
     private:
          ...
          LITHIUM::Timer m_MountUpdateTimer;
