...
/* main() for one LITHIUM driver process.
 * Drivers define IS*() functions we call to deliver LITHIUM XML arriving on stdin.
 * Drivers call ID*() functions to send LITHIUM XML commands to stdout.
