...
namespace LITHIUM
{
    char Logger::Tags[Logger::nlevels][MAXLITHIUMNAME] = {"ERROR", "WARNING", "INFO", "DEBUG",
    ...
    LITHIUM::DefaultDevice *Logger::parentDevice = nullptr;
    ...
    int Logger::addDebugLevel(const char *debugLevelName, const char *loggingLevelName)
    {
        ...
        strncpy(Tags[customLevel], loggingLevelName, MAXLITHIUMNAME);
        strncpy(DebugLevelSInit[customLevel].label, debugLevelName, MAXLITHIUMNAME);
        strncpy(LoggingLevelSInit[customLevel].label, debugLevelName, MAXLITHIUMNAME);
                           ...
                           const int screenVerbosityLevel)
    {
        ...
        {
            LITHIUM::mkpath(logDir_.c_str(), 0775);
