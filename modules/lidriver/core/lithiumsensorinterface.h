 ...
 * true in Connect().
 *
 * Developers need to subclass LITHIUM::Sensor to implement any driver for Sensors within LITHIUM.
 *
...
namespace LITHIUM
{
    ...
    private:
        ...
        char integrationExtention[MAXLITHIUMBLOBFMT];
