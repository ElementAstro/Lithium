 ...
 *
 * Developers need to subclass Telescope to implement any driver for telescopes within LITHIUM.
 *
...
namespace LITHIUM
{
    ...
    protected:
         ...
         * warning message.
         */
        virtual bool MoveNS(LITHIUM_DIR_NS dir, TelescopeMotionCommand command);
         ...
         * warning message.
         */
        virtual bool MoveWE(LITHIUM_DIR_WE dir, TelescopeMotionCommand command);
        ...
        // Reverse NS or WE
        LITHIUM::PropertySwitch ReverseMovementSP{2};
        enum
        {
            REVERSE_NS,
            REVERSE_WE
