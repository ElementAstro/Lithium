 ...
 *
 * \e IMPORTANT: GEOGRAPHIC_COORD stores latitude and longitude in LITHIUM specific format, refer to
 * <a href="http://indilib.org/develop/developer-manual/101-standard-properties.html">LITHIUM Standard
