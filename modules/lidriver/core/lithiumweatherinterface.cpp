...
namespace LITHIUM
{
    ...
    void WeatherInterface::createParameterRange(std::string name, std::string label)
    {
        ...
        char propName[MAXLITHIUMNAME];
        char propLabel[MAXLITHIUMLABEL];
        snprintf(propName, MAXLITHIUMNAME, "%s", name.c_str());
        snprintf(propLabel, MAXLITHIUMLABEL, "%s", label.c_str());
