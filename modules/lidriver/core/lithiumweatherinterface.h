...
// Alias
using WI = LITHIUM::WeatherInterface;
...
namespace LITHIUM
{
     ...
     * \class WeatherInterface
       ...
       When developing a driver for a fully independent weather device, use LITHIUM::Weather directly. To add focus functionality to
       an existing driver, subclass LITHIUM::WeatherInterface. In your driver, then call the necessary weather interface functions.
       ...
       Implement and overwrite the rest of the virtual functions as needed. LITHIUM Pegasus Ultimate Power Box driver is a good example to check for an actual implementation
