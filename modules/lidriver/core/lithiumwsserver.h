...
public:
    ...
    void run()
    {
        try
        {
            ...
            m_server->set_open_handler(bind(&LITHIUMWSServer::on_open, this, ::_1));
            m_server->set_close_handler(bind(&LITHIUMWSServer::on_close, this, ::_1));
            // m_server->set_message_handler(bind(&LITHIUMWSServer::on_message,this,::_1,::_2));
