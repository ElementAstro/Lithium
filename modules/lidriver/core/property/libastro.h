...
#define DEG_TO_RAD(deg) (deg * M_PI / 180.0)
     ...
     * @param object Equatorial Object Coordinates in LITHIUM standaard (RA Hours, DE degrees).
     * @param observer Observer Location in LITHIUM Standard (Longitude 0 to 360 Increasing Eastward)
     ...
     * @param observer Observer Location in LITHIUM Standard (Longitude 0 to 360 Increasing Eastward)
     * @param JD Julian Date
     * @param position Calculated Equatorial Coordinates in LITHIUM standards (RA hours, DE degrees).
