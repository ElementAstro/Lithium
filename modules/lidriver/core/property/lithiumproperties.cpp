...
namespace LITHIUM
{
    ...
    void Properties::push_back(const LITHIUM::Property &property)
    {
        D_PTR(Properties);
        d->properties.push_back(property);
    }

    void Properties::push_back(LITHIUM::Property &&property)
    {
        D_PTR(Properties);
    ...
    LITHIUM::Properties Properties::operator*()
    {
        return *this;
    }

    const LITHIUM::Properties Properties::operator*() const
    {
        return *this;
    }
    ...
    Properties::operator std::vector<LITHIUM::Property *> *()
    {
        D_PTR(Properties);
    ...
    Properties::operator const std::vector<LITHIUM::Property *> *() const
    {
        D_PTR(const Properties);
        d->propertiesBC.resize(0);
        d->propertiesBC.reserve(d->properties.size());
        for (auto &it : d->properties)
            d->propertiesBC.push_back(const_cast<LITHIUM::Property *>(&it));
