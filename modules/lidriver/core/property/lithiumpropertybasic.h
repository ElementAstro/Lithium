...
namespace LITHIUM
{
    ...
    using WidgetText = LITHIUM::WidgetViewText;
    using WidgetNumber = LITHIUM::WidgetViewNumber;
    using WidgetSwitch = LITHIUM::WidgetViewSwitch;
    using WidgetLight = LITHIUM::WidgetViewLight;
    using WidgetBlob = LITHIUM::WidgetViewBlob;

    template <typename>
    class PropertyBasicPrivateTemplate;

    template <typename T>
    class PropertyBasic : public LITHIUM::Property
    {
    ...
    public: // deprecated
        LITHIUM_DEPRECATED("Do not use LITHIUM::PropertyXXX as pointer.")
        LITHIUM::PropertyView<T> *operator->();
