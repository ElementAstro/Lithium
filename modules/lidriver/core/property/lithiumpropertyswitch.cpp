...
namespace LITHIUM
{
    ...
    PropertySwitch::PropertySwitch(LITHIUM::Property property)
    ...
    LITHIUM::WidgetViewSwitch *PropertySwitch::findOnSwitch() const
    {
        D_PTR(const PropertySwitch);
    ...
    void PropertySwitch::onNewValues(const std::function<void(const LITHIUM::PropertySwitch::NewValues &)> &callback)
    {
        D_PTR(PropertySwitch);
