...
#define PROPERTYVIEW_BASE_ACCESS public
    ...
    /**
     * \class LITHIUM::PropertyView and LITHIUM::WidgetView
     * \brief Provides decorator for Low-Level IXXXVectorProperty/IXXX
     *
     * LITHIUM::PropertyView
     *
    ...
    public:
        ...
        void fill(
            ...
            IPerm permission, double timeout, IPState state); /* outside implementation - only driver side, see indipropertyview_driver.cpp */
        ...
        void fill(
            const char *device, const char *name, const char *label, const char *group,
            IPerm permission, ISRule rule, double timeout, IPState state); /* outside implementation - only driver side, see indipropertyview_driver.cpp */

        template <typename X = T, enable_if_is_same_t<X, ILight> = true>
        void fill(
            const char *device, const char *name, const char *label, const char *group,
            IPState state); /* outside implementation - only driver side, see indipropertyview_driver.cpp */
    ...
    public:
        ...
        */
        ...
        bool update(
            ...
            const char *const names[], int n); /* outside implementation - only driver side, see indipropertyview_driver.cpp */
    ...
    public: // setters
        ...
        {
            LITHIUM::strlcpy(this->name, name);
        }
        ...
        {
            LITHIUM::strlcpy(this->label, label);
        }
        ...
        {
            LITHIUM::strlcpy(this->text = static_cast<char *>(realloc(this->text, size + 1)), text, size + 1);
        }
    ...
    public:
        void fill(const char *name, const char *label, const char *initialText); /* outside implementation - only driver side, see indipropertyview_driver.cpp */
    ...
    public: // setters
        ...
        {
            LITHIUM::strlcpy(this->format, format);
        }
    ...
    public:
        void fill(const char *name, const char *label, const char *format,
                  double min, double max, double step, double value); /* outside implementation - only driver side, see indipropertyview_driver.cpp */
    ...
    public:
        void fill(const char *name, const char *label, ISState state = ISS_OFF); /* outside implementation - only driver side, see indipropertyview_driver.cpp */
    ...
    public:
        void fill(const char *name, const char *label, IPState state = IPS_OK); /* outside implementation - only driver side, see indipropertyview_driver.cpp */
    ...
    public:
        void fill(const char *name, const char *label, const char *format); /* outside implementation - only driver side, see indipropertyview_driver.cpp */
    ...
    {
        LITHIUM::strlcpy(this->device, name);
    }
    ...
    {
        LITHIUM::strlcpy(this->group, name);
    }
    ...
    {
        LITHIUM::strlcpy(this->timestamp, timestamp);
    }
