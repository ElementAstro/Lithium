...
namespace LITHIUM
{
    ...
    bool MJPEGEncoder::upload(LITHIUM::WidgetViewBlob *bp, const uint8_t *buffer, uint32_t nbytes, bool isCompressed)
    {
        ...
        LITHIUM_UNUSED(nbytes);
        int bufsize = rawWidth * rawHeight * ((pixelFormat == LITHIUM_RGB) ? 3 : 1);
