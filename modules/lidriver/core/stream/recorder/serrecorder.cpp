...
namespace LITHIUM
{
    ...
    {
        name = "SER";
        strncpy(serh.FileID, "LITHIUM-RECORDER", 14);
    ...
    bool SER_Recorder::setPixelFormat(LITHIUM_PIXEL_FORMAT pixelFormat, uint8_t pixelDepth)
    {
        ...
        case LITHIUM_BAYER_BGGR:
            serh.ColorID = SER_BAYER_BGGR;
            break;
        case LITHIUM_BAYER_GBRG:
            serh.ColorID = SER_BAYER_GBRG;
            break;
        case LITHIUM_BAYER_GRBG:
            serh.ColorID = SER_BAYER_GRBG;
            break;
        case LITHIUM_BAYER_RGGB:
