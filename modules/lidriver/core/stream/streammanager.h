 ...
 * \class StreamManager
   ...
   LITHIUM::CCD can utilize this class to add streaming and recording functionality to the driver.
   ...
   * _F_ is replaced with the filter name currently in use (see Snoop Devices in Options tab)
   ...
   2. OGV recorder: Saves video streams in libtheora OGV files. LITHIUM must be compiled with the optional OGG Theora support for this functionality to be
...
namespace LITHIUM
{
    ...
    public:
        ...
        bool setPixelFormat(LITHIUM_PIXEL_FORMAT pixelFormat, uint8_t pixelDepth = 8);
