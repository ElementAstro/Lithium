...
namespace LITHIUM
{
    ...
    public:
        ...
        bool setPixelFormat(LITHIUM_PIXEL_FORMAT pixelFormat, uint8_t pixelDepth);
    ...
    public:
        ...
        /* Stream switch */
        LITHIUM::PropertySwitch StreamSP{2};

        LITHIUM::PropertyNumber StreamTimeNP{1};

        /* Record switch */
        LITHIUM::PropertySwitch RecordStreamSP{4};
        enum
        {
            RECORD_ON,
            RECORD_TIME,
        ...
        /* Record File Info */
        LITHIUM::PropertyText RecordFileTP{2};

        LITHIUM::PropertyNumber StreamExposureNP{2};
        enum
        {
            STREAM_EXPOSURE,
            STREAM_DIVISOR,
        ...
        /* Measured FPS */
        LITHIUM::PropertyNumber FpsNP{2};
        enum
        {
            FPS_INSTANT,
            FPS_AVERAGE
        ...
        /* Record Options */
        LITHIUM::PropertyNumber RecordOptionsNP{2};

        // Stream Frame
        LITHIUM::PropertyNumber StreamFrameNP{4};

        /* BLOBs */
        LITHIUM::PropertyBlob imageBP{LITHIUM::Property()};

        // Encoder Selector. It's static now but should this implemented as plugin interface?
        LITHIUM::PropertySwitch EncoderSP{2};
        enum
        {
            ENCODER_RAW,
            ENCODER_MJPEG
        ...
        LITHIUM::PropertySwitch RecorderSP{2};
        enum
        {
            RECORDER_RAW,
            RECORDER_OGV
        ...
        LITHIUM::PropertyNumber LimitsNP{2};
        enum
        {
            LIMITS_BUFFER_MAX,
            LIMITS_PREVIEW_FPS
        ...
        LITHIUM_PIXEL_FORMAT PixelFormat = LITHIUM_MONO;
