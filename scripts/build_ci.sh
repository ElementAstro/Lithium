...
sudo apt install libspdlog-dev libboost-dev libgsl-dev libcfitsio-dev libz-dev python3-dev libssl-dev libsqlite3-dev libboost-system-dev libbboost-thread-dev 
