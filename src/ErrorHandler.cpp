...
ErrorHandler::handleError(const Status &status, const oatpp::String &message, const Headers &headers)
{
    ...
    if (status.code == 404)
    {
        auto response = ResponseFactory::createResponse(Status::CODE_404, fmt::format(R"(
            <!DOCTYPE html>
            <html lang="en">
            <head>
                <meta charset="UTF-8" />
            ...
            <body>
                ...
                <div id="container">
                    ...
                    inconvenience. The server will automatically restart in a few minutes.
                    ...
                    <div id="stopcode">
                        ...
                        <br />
                        <a
                            href="https://github.com/ElementAstro/Lithium/issues"
                        >
