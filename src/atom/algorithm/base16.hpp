...
namespace Atom::Algorithm
{
     ...
     *
     * This function takes a vector of unsigned characters and encodes it into a Base16 string representation.
     * Base16 encoding, also known as hexadecimal encoding, represents each byte in the input data as a pair
     ...
     *
     * This function takes a Base16 encoded string and decodes it into a vector of unsigned characters.
     * Base16 encoding, also known as hexadecimal encoding, represents each byte in the input data as a pair
     * of hexadecimal digits (0-9, A-F).
     *
