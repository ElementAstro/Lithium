...
namespace Atom::Algorithm
{
     ...
     *
     * This function takes a vector of unsigned characters and encodes it into a Base85 string representation.
     * Base85 encoding is a binary-to-text encoding scheme that encodes 4 bytes into 5 ASCII characters.
     *
     ...
     *
     * This function takes a Base85 encoded string and decodes it into a vector of unsigned characters.
     * Base85 encoding is a binary-to-text encoding scheme that encodes 4 bytes into 5 ASCII characters.
     *
