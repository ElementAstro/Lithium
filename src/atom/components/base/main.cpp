...
MySharedComponent::MySharedComponent(const std::string &name) : SharedComponent(name)
{
...
int main()
{
    std::shared_ptr<MySharedComponent> mycomponent = std::make_shared<MySharedComponent>("mycomponent");
