...
Solver::Solver(const std::string &name) : AtomDriver(name), m_debug(debug), m_imagePath("")
{
...
bool Solver::connect(const json &params)
{
    return true;
}

bool Solver::disconnect(const json &params)
{
    return true;
}

bool Solver::reconnect(const json &params)
{
    return true;
}
...
bool Solver::_solveImage(const json &params)
{
    ...
    if (!solveImage(GetVariable("imagePath").value(), GetVariable("timeout").value(), GetVariable("debug").value()))
    {
...
bool Solver::solveImage(const std::string &image, const int &timeout = 30, const bool &debug = false)
{
}

bool Solver::_getSolveParams(const json &params)
{
    return true;
}
...
bool Solver::_getSolveResult(const json &params)
{
    return true;
}

bool Solver::getSolveResult(const int &timeout = 30, const bool &debug = false)
{
}

bool Solver::_getSolveStatus(const json &params)
{
    return true;
}

bool Solver::getSolveStatus(const int &timeout = 30, const bool &debug = false)
{
}

bool Solver::_setSolveParams(const json &params)
{
    return true;
}
