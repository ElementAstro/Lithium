...
namespace Atom::Error
{
	...
	{
	public:
		explicit ObjectAlreadyExist(const std::string &msg) : std::logic_error(msg){};
	};
	...
	{
	public:
		explicit ObjectUninitialized(const std::string &msg) : std::logic_error(msg){};
	};
	...
	{
	public:
		explicit UnlawfulOperation(const std::string &msg) : std::logic_error(msg){};
	};
	...
	{
	public:
		explicit FailToUnloadDll(const std::string &msg) : std::runtime_error(msg){};
	};

	class FailToGetFunction : public std::runtime_error
	{
	public:
		explicit FailToGetFunction(const std::string &msg) : std::runtime_error(msg){};
	};

	class FailToCreateObject : public std::runtime_error
	{
	public:
		explicit FailToCreateObject(const std::string &msg) : std::runtime_error(msg){};
	};

	class FailToDestroyObject : public std::runtime_error
	{
	public:
		explicit FailToDestroyObject(const std::string &msg) : std::runtime_error(msg){};
	};

	class FailToCallFunction : public std::runtime_error
	{
	public:
		explicit FailToCallFunction(const std::string &msg) : std::runtime_error(msg){};
	};

	class FailToCallMemberFunction : public std::runtime_error
	{
	public:
		explicit FailToCallMemberFunction(const std::string &msg) : std::runtime_error(msg){};
	};

	class FailToCallStaticFunction : public std::runtime_error
	{
	public:
		explicit FailToCallStaticFunction(const std::string &msg) : std::runtime_error(msg){};
	};
}
