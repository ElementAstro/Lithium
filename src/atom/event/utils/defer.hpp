...
public:
    ...
    DeferExec(DeferExec &&other) noexcept
        : c_(std::move(other.c_)), canceled_(other.canceled_) {
...
#define MAKE_DEFER(r, l) \
    auto CONCAT_XY(defer_exec_, l) = Atom::Event::make_defer([&]() { r; })
