...
const char *kTraceStrings[] = {"NONE", "ERROR", "WARN",
                               "INFO", "DEBUG", "VERBOS"};

#ifdef ATOM_OS_ANDROID
const int kAndroidLogLevels[] = {ANDROID_LOG_INFO,  ANDROID_LOG_ERROR,
...
void setTraceFunc(TraceFunc func) { s_traceFunc = std::move(func); }

void setTraceLevel(int level) { s_traceLevel = level; }

int getTraceLevel() { return s_traceLevel; }
