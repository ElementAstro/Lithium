...
Description: Json <-> Python converter from(https://github.com/pybind/pybind11_json)

**************************************************/

#ifndef ATOM_SCRIPT_JSON_HPP
#define ATOM_SCRIPT_JSON_HPP
...
inline nl::json to_json(const py::handle& obj) {
    ...
    if (py::isinstance<py::int_>(obj)) {
        ...
        throw std::runtime_error(
            ...
            "nl::json::number_integer_t and nl::json::number_unsigned_t "
            "type: " +
