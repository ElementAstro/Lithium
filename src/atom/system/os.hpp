...
namespace Atom::System
{
     ...
     *
     * This function traverses a directory and its subdirectories, calling the specified
     * callback function for each file encountered.
     *
    ...
    /**
     * @brief Recursively walks through a directory and its subdirectories, applying a callback function to each file.
     *
     * This function traverses a directory and its subdirectories, calling the specified
     * callback function for each file encountered.
     *
     ...
     *
     * This function retrieves all the environment variables and their corresponding values,
     * and returns them as an unordered map.
     *
     * @return An unordered map containing the environment variables and their values.
     */
     ...
     *
     * This function returns the name of the controlling terminal associated with the current process.
     *
     ...
     *
     * This function retrieves the login name of the user associated with the current process.
     *
