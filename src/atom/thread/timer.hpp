...
namespace Atom::Async
{
    ...
    public:
         ...
         * @param repeatCount The number of times the task should be repeated. -1 for infinite repetition.
         * @param priority The priority of the task.
         */
        TimerTask(std::function<void()> func, unsigned int delay, int repeatCount, int priority);

        /**
         * @brief Comparison operator for comparing two TimerTask objects based on their next execution time.
         *
         * @param other Another TimerTask object to compare to.
         * @return True if this task's next execution time is earlier than the other task's next execution time.
         */
    ...
    public:
        ...
        [[nodiscard]] std::future<typename std::result_of<Function(Args...)>::type> setTimeout(Function &&func, unsigned int delay, Args &&...args);

        /**
         * @brief Schedules a task to be executed repeatedly at a specified interval.
         *
         * @tparam Function The type of the function to be executed.
         * @tparam Args The types of the arguments to be passed to the function.
         * @param func The function to be executed.
         * @param interval The interval in milliseconds between executions.
         * @param repeatCount The number of times the function should be repeated. -1 for infinite repetition.
         * @param priority The priority of the task.
         * @param args The arguments to be passed to the function.
         */
        template <typename Function, typename... Args>
    ...
    private:
        ...
        std::jthread m_thread; ///< The thread for running the timer loop (C++20 or later).
#else
