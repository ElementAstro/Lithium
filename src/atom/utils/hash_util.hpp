...
namespace Atom::Utils
{
     ...
     * @return uint32_t The calculated hash value.
     */
    [[nodiscard]] uint32_t murmur3Hash(const void *str, const uint32_t &size, const uint32_t &seed);
     ...
     */
    [[nodiscard]] uint64_t murmur3Hash64(const char *str, const uint32_t &seed, const uint32_t &seed2);
     ...
     * @return uint64_t The calculated hash value.
     */
    [[nodiscard]] uint64_t murmur3Hash64(const void *str, const uint32_t &size, const uint32_t &seed , const uint32_t &seed2);
     ...
     */
    [[nodiscard]] void hexstring_from_data(const void *data, size_t len, char *output);
     ...
     */
    [[nodiscard]] void data_from_hexstring(const char *hexstring, size_t length, void *output);
