...
/**
 * @brief Encodes a data buffer as Base64.
 * 
...
/**
 * @brief Calculates the MD5 hash value for a given string.
 * 
 * @param data The input string.
 * @return std::string The MD5 hash value in hexadecimal format.
 */
std::string md5(const std::string& data);

/**
 * @brief Calculates the SHA1 hash value for a given string.
 * 
 * @param data The input string.
 * @return std::string The SHA1 hash value in hexadecimal format.
 */
std::string sha1(const std::string& data);

/**
 * @brief Calculates the MD5 hash value for a given data buffer.
 * 
 * @param data The input data buffer.
 * @param len The length of the data buffer.
 * @return std::string The MD5 hash value as raw binary data.
 */
std::string md5sum(const void* data, size_t len);

/**
 * @brief Calculates the SHA1 hash value for a given data buffer.
 * 
 * @param data The input data buffer.
 * @param len The length of the data buffer.
 * @return std::string The SHA1 hash value as raw binary data.
 */
std::string sha1sum(const void* data, size_t len);

/**
 * @brief Calculates the HMAC-MD5 hash value for a given text and key.
 * 
 * @param text The input text.
 * @param key The HMAC key.
 * @return std::string The HMAC-MD5 hash value in hexadecimal format.
 */
std::string hmac_md5(const std::string& text, const std::string& key);

/**
 * @brief Calculates the HMAC-SHA1 hash value for a given text and key.
 * 
 * @param text The input text.
 * @param key The HMAC key.
 * @return std::string The HMAC-SHA1 hash value in hexadecimal format.
 */
std::string hmac_sha1(const std::string& text, const std::string& key);

/**
 * @brief Calculates the HMAC-SHA256 hash value for a given text and key.
 * 
 * @param text The input text.
 * @param key The HMAC key.
 * @return std::string The HMAC-SHA256 hash value in hexadecimal format.
 */
