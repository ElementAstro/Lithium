...
namespace Atom::Web
{
     ...
     *
     * This class provides functionality to set various options for the HTTP request, perform synchronous and asynchronous requests,
     * and handle response callbacks. It uses libcurl library for making HTTP requests.
     */
    class CurlWrapper
    {
    public:
        ...
        /**
         * @brief Perform an asynchronous HTTP request and invoke a callback function when the response is received.
         *
    ...
    private:
        ...
        /**
         * @brief Callback function used by libcurl to write response data into responseData member variable.
         *
