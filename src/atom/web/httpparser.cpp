...
void HttpHeaderParser::setHeaderValue(const std::string &key, const std::string &value)
{
    m_pImpl->headers_[key] = {value};
}

void HttpHeaderParser::setHeaders(const std::map<std::string, std::vector<std::string>> &headers)
{
    m_pImpl->headers_ = headers;
}

std::vector<std::string> HttpHeaderParser::getHeaderValues(const std::string &key) const
{
...
std::map<std::string, std::vector<std::string>> HttpHeaderParser::getAllHeaders() const
{
