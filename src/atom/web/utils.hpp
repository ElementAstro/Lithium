...
namespace Atom::Web
{
     ...
     * @return `true` if the string is in IPv6 format, `false` otherwise. 如果字符串为IPv6格式，则返回true；否则返回false。
     */
     ...
     *
     * @param str The string to check. 要检查的字符串。
     * @return `true` if the string is in IPv4 format, `false` otherwise. 如果字符串为IPv4格式，则返回true；否则返回false。
     */
