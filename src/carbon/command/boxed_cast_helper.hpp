...
#ifndef CARBON_BOXED_CAST_HELPER_HPP
#define CARBON_BOXED_CAST_HELPER_HPP
...
template <typename T>
static const T *verify_type_no_throw(const Boxed_Value &ob,
                                     const std::type_info &ti, const T *ptr) {
...
template <typename T>
static T *verify_type_no_throw(const Boxed_Value &ob, const std::type_info &ti,
                               T *ptr) {
...
template <typename T>
static const T *verify_type(const Boxed_Value &ob, const std::type_info &ti,
                            const T *ptr) {
...
struct Cast_Helper_Inner {
    static Result cast(const Boxed_Value &ob, const Type_Conversions_State *) {
        return *static_cast<const Result *>(
            verify_type(ob, typeid(Result), ob.get_const_ptr()));
    }
};
...
struct Cast_Helper_Inner<const Result *> {
    static const Result *cast(const Boxed_Value &ob,
...
struct Cast_Helper_Inner<Result *> {
    static Result *cast(const Boxed_Value &ob, const Type_Conversions_State *) {
        return static_cast<Result *>(
            verify_type_no_throw(ob, typeid(Result), ob.get_ptr()));
    }
};
...
struct Cast_Helper_Inner<const Result *const &>
    : public Cast_Helper_Inner<const Result *> {};
...
struct Cast_Helper_Inner<Result &> {
    static Result &cast(const Boxed_Value &ob, const Type_Conversions_State *) {
        return *static_cast<Result *>(
            verify_type(ob, typeid(Result), ob.get_ptr()));
    }
};
...
struct Cast_Helper_Inner<Result &&> {
    static Result &&cast(const Boxed_Value &ob,
                         const Type_Conversions_State *) {
        return std::move(*static_cast<Result *>(
            verify_type(ob, typeid(Result), ob.get_ptr())));
    }
};
...
struct Cast_Helper_Inner<std::unique_ptr<Result> &&> {
    static std::unique_ptr<Result> &&cast(const Boxed_Value &ob,
                                          const Type_Conversions_State *) {
        return std::move(
            *(ob.get().cast<std::shared_ptr<std::unique_ptr<Result>>>()));
    }
};
...
struct Cast_Helper_Inner<std::shared_ptr<const Result>> {
    static auto cast(const Boxed_Value &ob, const Type_Conversions_State *) {
        if (!ob.get_type_info().is_const()) {
            return std::const_pointer_cast<const Result>(
                ob.get().cast<std::shared_ptr<Result>>());
        } else {
...
struct Cast_Helper_Inner<Boxed_Value> {
    static Boxed_Value cast(const Boxed_Value &ob,
                            const Type_Conversions_State *) {
        return ob;
    }
};
...
template <>
struct Cast_Helper_Inner<Boxed_Value &> {
    static std::reference_wrapper<Boxed_Value> cast(
        const Boxed_Value &ob, const Type_Conversions_State *) {
...
/// The exposed Cast_Helper object that by default just calls the
/// Cast_Helper_Inner
template <typename T>
struct Cast_Helper {
    static decltype(auto) cast(const Boxed_Value &ob,
