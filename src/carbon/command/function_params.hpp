...
#ifndef CARBON_FUNCTION_PARAMS_HPP
#define CARBON_FUNCTION_PARAMS_HPP
...
public:
    constexpr Function_Params(const Boxed_Value *const t_begin,
                              const Boxed_Value *const t_end)
    ...
    [[nodiscard]] constexpr const Boxed_Value &operator[](
...
template <>
constexpr Function_Params::Function_Params(
    const std::array<Boxed_Value, size_t{0}> & /* a */)
