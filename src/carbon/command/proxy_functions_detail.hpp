...
Ret call_func(Ret (*)(Params...), std::index_sequence<I...>, const Callable &f,
              [[maybe_unused]] const Carbon::Function_Params &params,
...
Boxed_Value call_func(Ret (*sig)(Params...), const Callable &f,
    ...
    if constexpr (std::is_same_v<Ret, void>) {
        call_func(sig, std::index_sequence_for<Params...>{}, f, params,
                  t_conversions);
