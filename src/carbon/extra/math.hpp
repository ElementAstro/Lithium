#ifndef CARBON_EXTRAS_MATH_HPP_
#define CARBON_EXTRAS_MATH_HPP_
...
ModulePtr cos(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::cos(p); }), "cos");
    return m;
}

template <typename Ret, typename Param>
ModulePtr sin(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::sin(p); }), "sin");
    return m;
}

template <typename Ret, typename Param>
ModulePtr tan(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::tan(p); }), "tan");
    return m;
}

template <typename Ret, typename Param>
ModulePtr acos(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::acos(p); }), "acos");
    return m;
}

template <typename Ret, typename Param>
ModulePtr asin(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::asin(p); }), "asin");
    return m;
}

template <typename Ret, typename Param>
ModulePtr atan(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::atan(p); }), "atan");
    return m;
}

template <typename Ret, typename Param1, typename Param2>
ModulePtr atan2(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) { return std::atan2(p1, p2); }),
           "atan2");
    return m;
}
...
ModulePtr cosh(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::cosh(p); }), "cosh");
    return m;
}

template <typename Ret, typename Param>
ModulePtr sinh(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::sinh(p); }), "sinh");
    return m;
}

template <typename Ret, typename Param>
ModulePtr tanh(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::tanh(p); }), "tanh");
    return m;
}

#ifndef CARBON_EXTRAS_MATH_SKIP_ADVANCED
template <typename Ret, typename Param>
ModulePtr acosh(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::acosh(p); }), "acosh");
    return m;
}

template <typename Ret, typename Param>
ModulePtr asinh(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::asinh(p); }), "asinh");
    return m;
}

template <typename Ret, typename Param>
ModulePtr atanh(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::atanh(p); }), "atanh");
    return m;
}
#endif
...
ModulePtr exp(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::exp(p); }), "exp");
    return m;
}

template <typename Ret, typename Param1, typename Param2>
ModulePtr frexp(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) { return std::frexp(p1, p2); }),
           "frexp");
    return m;
}
...
ModulePtr ldexp(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) { return std::ldexp(p1, p2); }),
           "ldexp");
    return m;
}
...
ModulePtr log(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::log(p); }), "log");
    return m;
}

template <typename Ret, typename Param>
ModulePtr log10(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::log10(p); }), "log10");
    return m;
}

template <typename Ret, typename Param1, typename Param2>
ModulePtr modf(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) { return std::modf(p1, p2); }),
           "modf");
    return m;
}
...
ModulePtr exp2(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::exp2(p); }), "exp2");
    return m;
}

template <typename Ret, typename Param>
ModulePtr expm1(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::expm1(p); }), "expm1");
    return m;
}

template <typename Ret, typename Param>
ModulePtr ilogb(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::ilogb(p); }), "ilogb");
    return m;
}

template <typename Ret, typename Param>
ModulePtr log1p(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::log1p(p); }), "log1p");
    return m;
}

template <typename Ret, typename Param>
ModulePtr log2(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::log2(p); }), "log2");
    return m;
}

template <typename Ret, typename Param>
ModulePtr logb(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::logb(p); }), "logb");
    return m;
}
...
ModulePtr scalbn(ModulePtr m = std::make_shared<Module>()) {
    m->add(
        Carbon::fun([](Param1 p1, Param2 p2) { return std::scalbn(p1, p2); }),
        "scalbn");
    return m;
}
...
ModulePtr scalbln(ModulePtr m = std::make_shared<Module>()) {
    m->add(
        Carbon::fun([](Param1 p1, Param2 p2) { return std::scalbln(p1, p2); }),
        "scalbln");
    return m;
}
#endif
...
ModulePtr pow(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) { return std::pow(p1, p2); }),
           "pow");
    return m;
}
...
ModulePtr sqrt(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::sqrt(p); }), "sqrt");
    return m;
}
...
ModulePtr cbrt(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::cbrt(p); }), "cbrt");
    return m;
}

template <typename Ret, typename Param1, typename Param2>
ModulePtr hypot(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) { return std::hypot(p1, p2); }),
           "hypot");
    return m;
}
...
ModulePtr erf(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::erf(p); }), "erf");
    return m;
}

template <typename Ret, typename Param>
ModulePtr erfc(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::erfc(p); }), "erfc");
    return m;
}

template <typename Ret, typename Param>
ModulePtr tgamma(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::tgamma(p); }), "tgamma");
    return m;
}

template <typename Ret, typename Param>
ModulePtr lgamma(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::lgamma(p); }), "lgamma");
    return m;
}
#endif
...
ModulePtr ceil(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::ceil(p); }), "ceil");
    return m;
}

template <typename Ret, typename Param>
ModulePtr floor(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::floor(p); }), "floor");
    return m;
}

template <typename Ret, typename Param1, typename Param2>
ModulePtr fmod(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) { return std::fmod(p1, p2); }),
           "fmod");
    return m;
}
...
ModulePtr trunc(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::trunc(p); }), "trunc");
    return m;
}

template <typename Ret, typename Param>
ModulePtr round(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::round(p); }), "round");
    return m;
}

template <typename Ret, typename Param>
ModulePtr lround(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::lround(p); }), "lround");
    return m;
}
...
ModulePtr llround(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::llround(p); }), "llround");
    return m;
}

template <typename Ret, typename Param>
ModulePtr rint(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::rint(p); }), "rint");
    return m;
}

template <typename Ret, typename Param>
ModulePtr lrint(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::lrint(p); }), "lrint");
    return m;
}
...
ModulePtr llrint(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::llrint(p); }), "llrint");
    return m;
}

template <typename Ret, typename Param>
ModulePtr nearbyint(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::nearbyint(p); }), "nearbyint");
    return m;
}
...
ModulePtr remainder(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun(
               [](Param1 p1, Param2 p2) { return std::remainder(p1, p2); }),
           "remainder");
    return m;
}
...
ModulePtr remquo(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2, Param3 p3) {
               return std::remquo(p1, p2, p3);
           }),
           "remquo");
    return m;
}
...
ModulePtr copysign(ModulePtr m = std::make_shared<Module>()) {
    m->add(
        Carbon::fun([](Param1 p1, Param2 p2) { return std::copysign(p1, p2); }),
        "copysign");
    return m;
}
...
ModulePtr nan(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::nan(p); }), "nan");
    return m;
}
...
ModulePtr nextafter(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun(
               [](Param1 p1, Param2 p2) { return std::nextafter(p1, p2); }),
           "nextafter");
    return m;
}
...
ModulePtr nexttoward(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun(
               [](Param1 p1, Param2 p2) { return std::nexttoward(p1, p2); }),
           "nexttoward");
    return m;
}
...
ModulePtr fdim(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) { return std::fdim(p1, p2); }),
           "fdim");
    return m;
}
...
ModulePtr fmax(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) { return std::fmax(p1, p2); }),
           "fmax");
    return m;
}
...
ModulePtr fmin(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) { return std::fmin(p1, p2); }),
           "fmin");
    return m;
}
...
ModulePtr fabs(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::fabs(p); }), "fabs");
    return m;
}
#endif
...
ModulePtr abs(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::abs(p); }), "abs");
    return m;
}
...
ModulePtr fpclassify(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::fpclassify(p); }),
           "fpclassify");
    return m;
}
#endif
...
ModulePtr isfinite(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::isfinite(p); }), "isfinite");
    return m;
}

template <typename Ret, typename Param>
ModulePtr isinf(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::isinf(p); }), "isinf");
    return m;
}

template <typename Ret, typename Param>
ModulePtr isnan(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::isnan(p); }), "isnan");
    return m;
}

template <typename Ret, typename Param>
ModulePtr isnormal(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::isnormal(p); }), "isnormal");
    return m;
}

template <typename Ret, typename Param>
ModulePtr signbit(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param p) { return std::signbit(p); }), "signbit");
    return m;
}
...
ModulePtr isgreater(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun(
               [](Param1 p1, Param2 p2) { return std::isgreater(p1, p2); }),
           "isgreater");
    return m;
}
...
ModulePtr isgreaterequal(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun([](Param1 p1, Param2 p2) {
               return std::isgreaterequal(p1, p2);
           }),
           "isgreaterequal");
    return m;
}
...
ModulePtr isless(ModulePtr m = std::make_shared<Module>()) {
    m->add(
        Carbon::fun([](Param1 p1, Param2 p2) { return std::isless(p1, p2); }),
        "isless");
    return m;
}
...
ModulePtr islessequal(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun(
               [](Param1 p1, Param2 p2) { return std::islessequal(p1, p2); }),
           "islessequal");
    return m;
}
...
ModulePtr islessgreater(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun(
               [](Param1 p1, Param2 p2) { return std::islessgreater(p1, p2); }),
           "islessgreater");
    return m;
}
...
ModulePtr isunordered(ModulePtr m = std::make_shared<Module>()) {
    m->add(Carbon::fun(
               [](Param1 p1, Param2 p2) { return std::isunordered(p1, p2); }),
           "isunordered");
    return m;
}
