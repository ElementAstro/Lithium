...
#ifndef CARBON_THREADING_HPP
#define CARBON_THREADING_HPP
...
#include <thread>
#else
#ifndef CARBON_NO_THREADS_WARNING
...
/// If the compiler definition CARBON_NO_THREADS is defined then thread safety
/// is disabled in ChaiScript. This has the result that some code is faster, because mutex locks are not required.
/// It also has the side effect that the Carbon::ChaiScript object may not be accessed from more than
...
namespace Carbon::detail::threading {
#ifndef CARBON_NO_THREADS
