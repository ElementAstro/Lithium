...
Filterwheel::Filterwheel(const std::string &address int device_number, const std::string &protocol) :
...
void Filterwheel::set_Position(int position)
{
    _put("position", position);
}