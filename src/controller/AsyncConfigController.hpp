...
Action
returnResponse(const oatpp::Object<GetConfigDTO>& body) {
...
ENDPOINT_ASYNC("GET", "/api/config/set", getUISetConfig){
    ENDPOINT_ASYNC_INIT(getUISetConfig) Action act()
        override{return request
...
ENDPOINT_ASYNC("GET", "/api/config/delete", getUIDeleteConfig){
    ENDPOINT_ASYNC_INIT(getUIDeleteConfig) Action act()
        override{return request
...
ENDPOINT_ASYNC("GET", "/api/config/load", getUILoadConfig){
    ENDPOINT_ASYNC_INIT(getUILoadConfig) Action act()
        override{return request
...
ENDPOINT_ASYNC("GET", "/api/config/save", getUISaveConfig){
    ENDPOINT_ASYNC_INIT(getUISaveConfig) Action act()
        override{return request
...
Action returnResponse(const oatpp::Object<SaveConfigDTO>& body) {
    OATPP_ASSERT_HTTP(body->path.getValue("") != "", Status::CODE_400,
                      "Missing Parameters");
    OATPP_ASSERT_HTTP(body->isAbsolute.getValue(true) != true, Status::CODE_400,
                      "Missing Parameters");
