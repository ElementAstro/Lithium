...
public:
    ...
    ENDPOINT_ASYNC("GET", "/api/io/directory/create", getUICreateDirectory){
        ENDPOINT_ASYNC_INIT(getUICreateDirectory) Action act() override{
            return request
...
Action
returnResponse(const oatpp::Object<CreateDirectoryDTO>& body) {
...
ENDPOINT_ASYNC("GET", "/api/io/directory/remove", getUIRemoveDirectory){
    ENDPOINT_ASYNC_INIT(getUIRemoveDirectory) Action act()
...
ENDPOINT_ASYNC("GET", "/api/io/directory/rename", getUIRenameDirectory){
    ENDPOINT_ASYNC_INIT(getUIRenameDirectory) Action act()
        override{return request
...
ENDPOINT_ASYNC("GET", "/api/io/directory/move", getUIMoveDirectory){
    ENDPOINT_ASYNC_INIT(getUIMoveDirectory) Action act()
        override{return request
...
Action returnResponse(const oatpp::Object<MoveDirectoryDTO>& body) {
    OATPP_ASSERT_HTTP(body->path.getValue("") != "", Status::CODE_400,
                      "Missing Parameters");
    OATPP_ASSERT_HTTP(body->new_path.getValue("") != "", Status::CODE_400,
                      "Missing Parameters");
...
ENDPOINT_ASYNC("GET", "/api/io/file/copy", getUICopyFile){
    ENDPOINT_ASYNC_INIT(getUICopyFile) Action act()
        override{return request
...
ENDPOINT_ASYNC("GET", "/api/io/file/move", getUIMoveFile){
    ENDPOINT_ASYNC_INIT(getUIMoveFile) Action act()
        override{return request
...
ENDPOINT_ASYNC("GET", "/api/io/file/rename", getUIRenameFile){
    ENDPOINT_ASYNC_INIT(getUIRenameFile) Action act()
        override{return request
...
Action returnResponse(const oatpp::Object<RenameFileDTO>& body) {
    OATPP_ASSERT_HTTP(body->path.getValue("") != "", Status::CODE_400,
                      "Missing Parameters");
    OATPP_ASSERT_HTTP(body->new_name.getValue("") != "", Status::CODE_400,
                      "Missing Parameters");
...
ENDPOINT_ASYNC("GET", "/api/io/file/remove", getUIRemoveFile){
    ENDPOINT_ASYNC_INIT(getUIRemoveFile) Action act()
        override{return request
