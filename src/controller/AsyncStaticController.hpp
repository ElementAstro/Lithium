...
#include OATPP_CODEGEN_BEGIN(ApiController)  //<- Begin Codegen
    ...
    ENDPOINT_ASYNC("GET", "/", IndexRequestHandler){
        ENDPOINT_ASYNC_INIT(IndexRequestHandler) Action act() override{
...
ENDPOINT_ASYNC("GET", "/client", ClientRequestHandler){
    ENDPOINT_ASYNC_INIT(ClientRequestHandler) Action act() override{
        auto response = controller->createResponse(
...
ENDPOINT_ASYNC("GET", "/novnc", NoVNCRequestHandler){
    ENDPOINT_ASYNC_INIT(NoVNCRequestHandler) Action act()
        override{auto response = controller->createResponse(
                     Status::CODE_200,
...
ENDPOINT_ASYNC("GET", "/webssh", WebSSHRequestHandler){
    ENDPOINT_ASYNC_INIT(WebSSHRequestHandler) Action act()
        override{auto response = controller->createResponse(
                     Status::CODE_200,
...
ENDPOINT_ASYNC("GET", "/static/*",
               Static){ENDPOINT_ASYNC_INIT(Static) Action act()
                           override{auto tail = request->getPathTail();
...
auto buffer = loadResource(
    path.getValue(""), {"json", "js", "css", "html", "jpg", "png", "robot"});
...
ENDPOINT_ASYNC("GET", "/css/*",
               AllStaticCSS){ENDPOINT_ASYNC_INIT(AllStaticCSS) Action act()
                                 override{auto tail = request->getPathTail();
OATPP_ASSERT_HTTP(tail, Status::CODE_400, "Empty filename");
oatpp::parser::Caret caret(tail);
auto pathLabel = caret.putLabel();
...
ENDPOINT_INFO(AllStaticJS) { info->summary = "All 'JavaScript File' endpoint"; }
ENDPOINT_ASYNC("GET", "/js/*",
               AllStaticJS){ENDPOINT_ASYNC_INIT(AllStaticJS) Action act()
                                override{auto tail = request->getPathTail();
OATPP_ASSERT_HTTP(tail, Status::CODE_400, "Empty filename");
oatpp::parser::Caret caret(tail);
auto pathLabel = caret.putLabel();
...
ENDPOINT_ASYNC("GET", "/json/*",
               AllStaticJSON){ENDPOINT_ASYNC_INIT(AllStaticJSON) Action act()
                                  override{auto tail = request->getPathTail();
OATPP_ASSERT_HTTP(tail, Status::CODE_400, "Empty filename");
oatpp::parser::Caret caret(tail);
auto pathLabel = caret.putLabel();
...
ENDPOINT_ASYNC("GET", "/font/*",
               AllStaticFont){ENDPOINT_ASYNC_INIT(AllStaticFont) Action act()
                                  override{auto tail = request->getPathTail();
OATPP_ASSERT_HTTP(tail, Status::CODE_400, "Empty filename");
oatpp::parser::Caret caret(tail);
auto pathLabel = caret.putLabel();
...
auto buffer =
    loadResource(path.getValue(""), {"tff", "tff", "woff", "woff2", "eot"});
OATPP_ASSERT_HTTP(buffer != "", Status::CODE_500, "Can't read file");
return _return(controller->createResponse(Status::CODE_200, buffer));
}
}
...
ENDPOINT_INFO(AllStaticNodeModules) {
    info->summary =
        "All 'Node Modules File' endpoint. This need to be changed to normal "
        "format";
}
ENDPOINT_ASYNC("GET", "/node_modules/*", AllStaticNodeModules){
    ENDPOINT_ASYNC_INIT(AllStaticNodeModules) Action act()
        override{auto tail = request->getPathTail();
OATPP_ASSERT_HTTP(tail, Status::CODE_400, "Empty filename");
oatpp::parser::Caret caret(tail);
auto pathLabel = caret.putLabel();
...
ENDPOINT_INFO(AllStaticSound) { info->summary = "All 'Sound File' endpoint"; }
ENDPOINT_ASYNC("GET", "/sounds/*",
               AllStaticSound){ENDPOINT_ASYNC_INIT(AllStaticSound) Action act()
                                   override{auto tail = request->getPathTail();
OATPP_ASSERT_HTTP(tail, Status::CODE_400, "Empty filename");
oatpp::parser::Caret caret(tail);
auto pathLabel = caret.putLabel();
...
ENDPOINT_ASYNC("GET", "/textures/*", AllStaticTextures){
    ENDPOINT_ASYNC_INIT(AllStaticTextures) Action act()
        override{auto tail = request->getPathTail();
OATPP_ASSERT_HTTP(tail, Status::CODE_400, "Empty filename");
oatpp::parser::Caret caret(tail);
auto pathLabel = caret.putLabel();
...
auto buffer = loadResource(path.getValue(""), {"gif", "png", "svg", "jpg"});
OATPP_ASSERT_HTTP(buffer != "", Status::CODE_500, "Can't read file");
return _return(controller->createResponse(Status::CODE_200, buffer));
}
}
...
ENDPOINT_ASYNC("GET", "/webfonts/*", AllStaticWebFonts){
    ENDPOINT_ASYNC_INIT(AllStaticWebFonts) Action act()
        override{auto tail = request->getPathTail();
OATPP_ASSERT_HTTP(tail, Status::CODE_400, "Empty filename");
oatpp::parser::Caret caret(tail);
auto pathLabel = caret.putLabel();
...
auto buffer =
    loadResource(path.getValue(""), {"eot", "svg", "ttf", "woff", "woff2"});
OATPP_ASSERT_HTTP(buffer != "", Status::CODE_500, "Can't read file");
return _return(controller->createResponse(Status::CODE_200, buffer));
}
}
