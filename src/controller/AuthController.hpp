...
public:
    ...
    ENDPOINT("POST", "users/signup", signUp, BODY_DTO(Object<SignUpDto>, dto)) {
    ...
    ENDPOINT("POST", "users/signin", signIn, BODY_DTO(Object<SignInDto>, dto)) {
    ...
    ENDPOINT("DELETE", "users", deleteUser, BUNDLE(String, userId)) {
        return createDtoResponse(Status::CODE_200,
                                 m_userService.deleteUserById(userId));
    }
};
