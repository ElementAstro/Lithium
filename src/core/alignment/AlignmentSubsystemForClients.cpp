...
{
void AlignmentSubsystemForClients::Initialise(const char *DeviceName, HYDROGEN::BaseClient *BaseClient)
{
...
void AlignmentSubsystemForClients::ProcessNewDevice(HYDROGEN::BaseDevice *DevicePointer)
{
...
void AlignmentSubsystemForClients::ProcessNewProperty(HYDROGEN::Property *PropertyPointer)
{
