...
bool BasicMathPlugin::Initialise(InMemoryDatabase *pInMemoryDatabase)
{
    ...
    switch (SyncPoints.size())
    {
        ...
        case 1:
        {
            ...
            HYDROGEN::IEquatorialCoordinates RaDec;
            HYDROGEN::IHorizontalCoordinates ActualSyncPoint1;
            ...
            switch (ApproximateMountAlignment)
            {
                ...
                {
                    HYDROGEN::IEquatorialCoordinates DummyRaDec;
                    //HYDROGEN::IHorizontalCoordinates DummyAltAz;
        ...
        case 2:
        {
            ...
            HYDROGEN::IEquatorialCoordinates RaDec1;
            HYDROGEN::IEquatorialCoordinates RaDec2;
            TelescopeDirectionVector ActualDirectionCosine1;
            ...
            {
                HYDROGEN::IHorizontalCoordinates ActualSyncPoint1;
                HYDROGEN::IHorizontalCoordinates ActualSyncPoint2;
        ...
        case 3:
        {
            ...
            HYDROGEN::IEquatorialCoordinates RaDec1, RaDec2, RaDec3;
            ...
            if (ApproximateMountAlignment == ZENITH)
            {
                HYDROGEN::IHorizontalCoordinates ActualSyncPoint1;
                HYDROGEN::IHorizontalCoordinates ActualSyncPoint2;
                HYDROGEN::IHorizontalCoordinates ActualSyncPoint3;
                EquatorialToHorizontal(&RaDec1, &Position, Entry1.ObservationJulianDate, &ActualSyncPoint1);
                EquatorialToHorizontal(&RaDec2, &Position, Entry2.ObservationJulianDate, &ActualSyncPoint2);
        ...
        default:
        {
                    ...
                    Itr != SyncPoints.end(); Itr++)
            {
                ...
                if (ApproximateMountAlignment == ZENITH)
                {
                    HYDROGEN::IHorizontalCoordinates ActualSyncPoint;
...
{
    HYDROGEN::IEquatorialCoordinates ActualRaDec;
    ...
    switch (SyncPoints.size())
    {
        case 0:
        {
            ...
            {
                case ZENITH:
                    HYDROGEN::IHorizontalCoordinates ActualAltAz;
            ...
            if (nullptr != CurrentFace)
            {
                ...
                if (CurrentFace == ActualConvexHull.faces)
                {
                            ...
                            Itr != SyncPoints.end(); Itr++)
                    {
                        ...
                        if (ApproximateMountAlignment == ZENITH)
                        {
                            HYDROGEN::IHorizontalCoordinates ActualPoint;
                    ...
                    HYDROGEN::IEquatorialCoordinates RaDec1;
                    HYDROGEN::IEquatorialCoordinates RaDec2;
                    HYDROGEN::IEquatorialCoordinates RaDec3;
                    TelescopeDirectionVector ActualDirectionCosine1;
                    TelescopeDirectionVector ActualDirectionCosine2;
    ...
    //    HYDROGEN::IHorizontalCoordinates ApparentAltAz;
