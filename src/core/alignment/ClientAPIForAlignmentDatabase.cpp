...
void ClientAPIForAlignmentDatabase::Initialise(HYDROGEN::BaseClient *BaseClient)
{
...
void ClientAPIForAlignmentDatabase::ProcessNewDevice(HYDROGEN::BaseDevice *DevicePointer)
{
...
void ClientAPIForAlignmentDatabase::ProcessNewProperty(HYDROGEN::Property *PropertyPointer)
{
