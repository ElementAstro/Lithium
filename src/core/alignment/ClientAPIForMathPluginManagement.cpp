...
void ClientAPIForMathPluginManagement::Initialise(HYDROGEN::BaseClient *BaseClient)
{
    ClientAPIForMathPluginManagement::BaseClient = BaseClient;
}

void ClientAPIForMathPluginManagement::ProcessNewDevice(HYDROGEN::BaseDevice *DevicePointer)
{
    Device = DevicePointer;
}

void ClientAPIForMathPluginManagement::ProcessNewProperty(HYDROGEN::Property *PropertyPointer)
{
