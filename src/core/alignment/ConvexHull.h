...
// For HYDROGEN alignment purposes we need to scale floating point coordinates
...
class ConvexHull
{
    public:
        ...
        /** \brief Print: Prints out the vertices and the faces.  Uses the vnum hydrogences
