...
bool NearestMathPlugin::Initialise(InMemoryDatabase *pInMemoryDatabase)
{
    ...
    for (auto &oneSyncPoint : SyncPoints)
    {
        ...
        HYDROGEN::IEquatorialCoordinates CelestialRADE {oneEntry.RightAscension, oneEntry.Declination};
        HYDROGEN::IHorizontalCoordinates CelestialAltAz;
        ...
        HYDROGEN::IHorizontalCoordinates TelescopeAltAz;
        // Alt-Az Mounts?
        ...
        {
            HYDROGEN::IEquatorialCoordinates TelescopeRADE;
        ...
        double JulianOffset, TelescopeDirectionVector &ApparentTelescopeDirectionVector)
{
    ...
    HYDROGEN::IEquatorialCoordinates CelestialRADE {RightAscension, Declination};
    HYDROGEN::IHorizontalCoordinates CelestialAltAz;
    ...
    HYDROGEN::IEquatorialCoordinates TransformedTelescopeRADE = CelestialRADE;
    ...
    if (ApproximateMountAlignment == ZENITH)
    {
        HYDROGEN::IHorizontalCoordinates TransformedTelescopeAltAz;
        ...
        double &RightAscension, double &Declination)
{
    ...
    HYDROGEN::IEquatorialCoordinates NearestTelescopeRADE;
    if (ApproximateMountAlignment == ZENITH)
    {
        HYDROGEN::IHorizontalCoordinates NearestTelescopeAltAz {nearest.TelescopeAzimuth, nearest.TelescopeAltitude};
    ...
    HYDROGEN::IEquatorialCoordinates TransformedCelestialRADE = TelescopeRADE;
