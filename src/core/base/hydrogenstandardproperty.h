...
namespace HYDROGEN
{
  ...
  The properties are defined as string constants. To refer to the property in device drivers, use HYDROGEN::StandardProperty::PROPERTY_NAME or the shortcut HYDROGEN::SP::PROPERTY_NAME.
  ...
  */
  namespace SP
  {
     ...
     * Name | Type | Member | Default | Description
     * ---- | ---- | ------ | ------- | -----------
     * DEVICE_AUTO_SEARCH | SWITCH | HYDROGEN_ENABLED | ON | Auto Search ON
     * DEVICE_AUTO_SEARCH | SWITCH | HYDROGEN_DISABLED | OFF | Auto Search OFF
     */
     ...
     * Name | Type | Member | Default | Description
     * ---- | ---- | ------ | ------- | -----------
     * DEVICE_LAN_SEARCH | SWITCH | HYDROGEN_ENABLED | OFF | LAN Search ON
     * DEVICE_LAN_SEARCH | SWITCH | HYDROGEN_DISABLED | ON | LAN Search OFF
     */
