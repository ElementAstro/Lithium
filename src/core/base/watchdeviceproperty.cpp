...
namespace HYDROGEN
{
    ...
    int WatchDeviceProperty::processXml(const HYDROGEN::LilXmlElement &root, char *errmsg, const std::function<ParentDevice()> &constructor)
    {
        ...
        return HYDROGEN_DISPATCH_ERROR;
    }
