 ...
 * @brief Combines all HYDROGEN Connection Plugins. Each HYDROGEN connection plugin is responsible of managing communications
 * with a specific physical or logical medium (e.g. serial or ethernet).
 */
namespace Connection
{
    /**
     * @brief The Interface class is the base class for all HYDROGEN connection plugins.
     *
     ...
     * @see Connection::TCP
     * @see HYDROGEN::Telescope utilizes both serial and tcp plugins to communicate with mounts.
     */
    class Interface
    {
    public:
         ...
         * @see HYDROGEN::Telescope
         */
        void registerHandshake(std::function<bool()> callback);

    protected:
        Interface(HYDROGEN::DefaultDevice *dev, Type type = CONNECTION_NONE);
        virtual ~Interface();
