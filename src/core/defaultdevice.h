...
/**
 * \class HYDROGEN::DefaultDevice
 * \brief Class to provide extended functionality for devices in addition
 * to the functionality provided by HYDROGEN::BaseDevice. This class should \e only be subclassed by
 * drivers directly as it is linked with main(). Virtual drivers cannot employ HYDROGEN::DefaultDevice.
 *
 * HYDROGEN::DefaultDevice provides capability to add Debug, Simulation, and Configuration controls.
...
namespace HYDROGEN
{
    ...
    public:
         ...
         */
        HYDROGEN_DEPRECATED("Use defineProperty(HYDROGEN::Property &).")
        ...
        void defineProperty(HYDROGEN::Property &property);
        /**
         ...
         */
        bool deleteProperty(HYDROGEN::Property &property);
    ...
    public:
         ...
         * \note This function is called by the HYDROGEN framework, do not call it directly. See LX200
         ...
         * \note This function is called by the HYDROGEN framework, do not call it directly.
        ...
        /**
         * \brief Process a snoop event from HYDROGEN server. This function is called when a snooped property is
    ...
    public:
         ...
         */
        void watchDevice(const char *deviceName, const std::function<void(HYDROGEN::BaseDevice)> &callback);
    ...
    protected:
         ...
         * @param defineEnabled True to define all dynamic properties in HYDROGEN::DefaultDevice own
         ...
         */
        bool loadConfig(HYDROGEN::Property &property);
         ...
         */
        bool saveConfig(HYDROGEN::Property &property);
        ...
        /**
         * \brief Connect to the device. HYDROGEN::DefaultDevice implementation connects to appropriate
