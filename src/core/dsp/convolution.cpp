...
namespace DSP
{
    ...
    Convolution::Convolution(HYDROGEN::DefaultDevice *dev) : Interface(dev, DSP_CONVOLUTION, "CONVOLUTION", "Convolution")
    {
    ...
    Wavelets::Wavelets(HYDROGEN::DefaultDevice *dev) : Interface(dev, DSP_WAVELETS, "WAVELETS", "Wavelets")
    {
        for (int i = 0; i < N_WAVELETS; i++)
        {
            char strname[MAXHYDROGENNAME];
            char strlabel[MAXHYDROGENLABEL];
