...
namespace DSP
{
    /**
     * @namespace DSP
     * @brief The DSP Namespace adds signal processing to HYDROGEN drivers. Primarily written for sensors and detectors, it can be used also
    ...
    {
        /**
         * @brief The Interface class is the base class for the DSP plugins of HYDROGEN.
         *
         ...
         * @see DSP::Transforms
         * @see DSP::Manager
         * @see HYDROGEN::CCD and HYDROGEN::SensorInterface utilize the DSP Namespace.
         */
    public:
        /**
         * \struct Type
    ...
    protected:
        ...
        Interface(HYDROGEN::DefaultDevice *dev, Type type = DSP_NONE, const char *name = "DSP_PLUGIN",
                  const char *label = "DSP Plugin");
        virtual ~Interface();

        const char *getDeviceName();
        HYDROGEN::DefaultDevice *m_Device{nullptr};
    ...
    private:
        char captureExtention[MAXHYDROGENBLOBFMT]{"fits"};
        void *buffer{nullptr};
