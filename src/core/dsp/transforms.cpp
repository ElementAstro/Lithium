...
namespace DSP
{
    ...
    FourierTransform::FourierTransform(HYDROGEN::DefaultDevice *dev) : Interface(dev, DSP_DFT, "DFT", "DFT")
    {
    }
    ...
    InverseFourierTransform::InverseFourierTransform(HYDROGEN::DefaultDevice *dev) : Interface(dev, DSP_IDFT, "IDFT", "IDFT")
    {
    ...
    Spectrum::Spectrum(HYDROGEN::DefaultDevice *dev) : Interface(dev, DSP_SPECTRUM, "SPECTRUM", "Spectrum")
    {
    }
    ...
    Histogram::Histogram(HYDROGEN::DefaultDevice *dev) : Interface(dev, DSP_HISTOGRAM, "HISTOGRAM", "Histogram")
    {
    }
