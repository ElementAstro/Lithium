...
namespace DSP
{
    ...
    {
    public:
        FourierTransform(HYDROGEN::DefaultDevice *dev);
    ...
    {
    public:
        InverseFourierTransform(HYDROGEN::DefaultDevice *dev);
    ...
    {
    public:
        Spectrum(HYDROGEN::DefaultDevice *dev);
        virtual bool processBLOB(uint8_t *out, uint32_t dims, int *sizes, int bits_per_sample) override;
    ...
    {
    public:
        Histogram(HYDROGEN::DefaultDevice *dev);
        virtual bool processBLOB(uint8_t *out, uint32_t dims, int *sizes, int bits_per_sample) override;
