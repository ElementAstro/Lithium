 ...
 * \class HYDROGEN::Dome
   ...
   Developers need to subclass HYDROGEN::Dome to implement any driver for Domes within HYDROGEN.
...
namespace HYDROGEN
{
     ...
     protected:
          ...
          HYDROGEN::IHorizontalCoordinates mountHoriztonalCoords;
          HYDROGEN::IEquatorialCoordinates mountEquatorialCoords;
     ...
     private:
          ...
          HYDROGEN::Timer m_MountUpdateTimer;
