...
namespace HYDROGEN
{
    char Logger::Tags[Logger::nlevels][MAXHYDROGENNAME] = {"ERROR", "WARNING", "INFO", "DEBUG",
    ...
    struct Logger::switchinit Logger::LoggingLevelSInit[] =
        {
            {"LOG_ERROR", "Errors", ISS_ON, DBG_ERROR}, {"LOG_WARNING", "Warnings", ISS_ON, DBG_WARNING}, {"LOG_SESSION", "Messages", ISS_ON, DBG_SESSION}, {"LOG_DEBUG", "Driver Debug", ISS_OFF, DBG_DEBUG}, {"LOG_EXTRA_1", "Log Extra 1", ISS_OFF, DBG_EXTRA_1}, {"LOG_EXTRA_2", "Log Extra 2", ISS_OFF, DBG_EXTRA_2}, {"LOG_EXTRA_3", "Log Extra 3", ISS_OFF, DBG_EXTRA_3}, {"LOG_EXTRA_4", "Log Extra 4", ISS_OFF, DBG_EXTRA_4}};
    ...
    HYDROGEN::DefaultDevice *Logger::parentDevice = nullptr;
    ...
    int Logger::addDebugLevel(const char *debugLevelName, const char *loggingLevelName)
    {
        ...
        strncpy(Tags[customLevel], loggingLevelName, MAXHYDROGENNAME);
        strncpy(DebugLevelSInit[customLevel].label, debugLevelName, MAXHYDROGENNAME);
        strncpy(LoggingLevelSInit[customLevel].label, debugLevelName, MAXHYDROGENNAME);
                           ...
                           const int screenVerbosityLevel)
    {
        ...
        {
            HYDROGEN::mkpath(logDir_.c_str(), 0775);
...
#include <sys/time.h>
                       ...
                       const char *message, ...)
    {
        ...
        HYDROGEN_UNUSED(file);
        HYDROGEN_UNUSED(line);
