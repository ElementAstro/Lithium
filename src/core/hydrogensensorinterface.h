 ...
 * true in Connect().
 *
 * Developers need to subclass HYDROGEN::Sensor to implement any driver for Sensors within HYDROGEN.
 *
...
namespace HYDROGEN
{
    ...
    private:
        ...
        char integrationExtention[MAXHYDROGENBLOBFMT];
