 ...
 *
 * Developers need to subclass Telescope to implement any driver for telescopes within HYDROGEN.
 *
...
namespace HYDROGEN
{
    ...
    protected:
         ...
         * warning message.
         */
        virtual bool MoveNS(HYDROGEN_DIR_NS dir, TelescopeMotionCommand command);
         ...
         * warning message.
         */
        virtual bool MoveWE(HYDROGEN_DIR_WE dir, TelescopeMotionCommand command);
        ...
        // Reverse NS or WE
        HYDROGEN::PropertySwitch ReverseMovementSP{2};
        enum
        {
            REVERSE_NS,
            REVERSE_WE
