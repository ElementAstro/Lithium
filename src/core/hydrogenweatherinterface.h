...
// Alias
using WI = HYDROGEN::WeatherInterface;
...
namespace HYDROGEN
{
     ...
     * \class WeatherInterface
       ...
       When developing a driver for a fully independent weather device, use HYDROGEN::Weather directly. To add focus functionality to
       an existing driver, subclass HYDROGEN::WeatherInterface. In your driver, then call the necessary weather interface functions.
       ...
       Implement and overwrite the rest of the virtual functions as needed. HYDROGEN Pegasus Ultimate Power Box driver is a good example to check for an actual implementation
