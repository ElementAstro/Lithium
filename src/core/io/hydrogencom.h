 ...
 *
 *  The HYDROGEN Common Routine Library provides formatting and serial routines employed by many HYDROGEN drivers. Currently, the library is composed of the following sections:
 *
 *  <ul>
 ...
 */
     ...
     *  \note buf must be of length MAXHYDROGENFORMAT at minimum
     */
     ...
     *  \param longitude Longitude in HYDROGEN format (0 to 360) increasing eastward.
     ...
     *  \param latitude latitude in HYDROGEN format (-90 to +90)
