...
namespace HYDROGEN
{
    ...
    PropertySwitch::PropertySwitch(HYDROGEN::Property property)
    ...
    HYDROGEN::WidgetViewSwitch *PropertySwitch::findOnSwitch() const
    {
        D_PTR(const PropertySwitch);
    ...
    void PropertySwitch::onNewValues(const std::function<void(const HYDROGEN::PropertySwitch::NewValues &)> &callback)
    {
        D_PTR(PropertySwitch);
