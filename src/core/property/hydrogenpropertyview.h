...
#define PROPERTYVIEW_BASE_ACCESS public
    ...
    /**
     * \class HYDROGEN::PropertyView and HYDROGEN::WidgetView
     * \brief Provides decorator for Low-Level IXXXVectorProperty/IXXX
     *
     * HYDROGEN::PropertyView
     *
    ...
    public: // setters
        ...
        {
            HYDROGEN::strlcpy(this->name, name);
        }
        ...
        {
            HYDROGEN::strlcpy(this->label, label);
        }
        ...
        {
            HYDROGEN::strlcpy(this->text = static_cast<char *>(realloc(this->text, size + 1)), text, size + 1);
        }
    ...
    public: // setters
        ...
        {
            HYDROGEN::strlcpy(this->format, format);
        }
    ...
    {
        HYDROGEN::strlcpy(this->device, name);
    }
    ...
    {
        HYDROGEN::strlcpy(this->group, name);
    }
    ...
    {
        HYDROGEN::strlcpy(this->timestamp, timestamp);
    }
