...
namespace HYDROGEN
{
    ...
    {
        name = "SER";
        strncpy(serh.FileID, "HYDROGEN-RECORDER", 14);
    ...
    bool SER_Recorder::setPixelFormat(HYDROGEN_PIXEL_FORMAT pixelFormat, uint8_t pixelDepth)
    {
        ...
        case HYDROGEN_BAYER_BGGR:
            serh.ColorID = SER_BAYER_BGGR;
            break;
        case HYDROGEN_BAYER_GBRG:
            serh.ColorID = SER_BAYER_GBRG;
            break;
        case HYDROGEN_BAYER_GRBG:
            serh.ColorID = SER_BAYER_GRBG;
            break;
        case HYDROGEN_BAYER_RGGB:
