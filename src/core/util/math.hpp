...
#define LithiumCore_Fraction_VERSION "v-1.1.0"
#define LithiumCore_Fraction_EDITTIME "2023/8/8"
#define LithiumCore_Fraction_AUTHOR "Max Qian"
...
namespace LithiumCore::Math
{
    ...
    public:
        ...
        Fraction(int num_value, int den_value) : numerator(num_value), denominator(den_value)
        {
            ...
            {
                throw LithiumCore::Utilities::WrongArgument_Error("Got 0 in the denominator of LithiumCore::Math::Fraction object!");
            }
        };
