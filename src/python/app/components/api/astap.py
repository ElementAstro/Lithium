...
from app.utils.process import subprocess_manager
...
async def solve(
    ...
    try:
        await subprocess_manager.run_command("astap_cli", *command[1:])
...
def astap_solve_blocking(
    ...
    Args:
        ...
        ra (Optional[float]): Current RA in degrees (converted to hours forASTAP).
