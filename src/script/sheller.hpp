...
namespace Lithium
{
    ...
    private:
        ...
        std::unordered_map<std::string, Script> powerShellScripts;  /**< Map to store registered PowerShell scripts. */
        std::unordered_map<std::string, std::string> scriptOutputs; /**< Map to store outputs of executed scripts. */
        std::unordered_map<std::string, int> scriptStatus;          /**< Map to store status codes of executed scripts. */
    ...
    public:
         ...
         */
        void RegisterPowerShellScript(const std::string &name, const Script &script);
         ...
         */
        bool RunScript(const std::string &name, const std::vector<std::string> &args = {});
    ...
    private:
         ...
         */
        bool RunCommand(const std::string &cmdLine, const std::string &name, const std::vector<std::string> &args);
