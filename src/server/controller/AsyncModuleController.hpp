...
#ifndef ASYNC_MODULE_CONTROLLER_HPP
#define ASYNC_MODULE_CONTROLLER_HPP
...
public:
    ...
    ENDPOINT_ASYNC("GET", "/api/module/load", getUILoadModule){
        ENDPOINT_ASYNC_INIT(getUILoadModule) Action act()
            override{return request
                         ->readBodyToDtoAsync<oatpp::Object<LoadPluginDto>>(
                             controller->getDefaultObjectMapper())
                         .callbackTo(&getUILoadModule::returnResponse);
}

Action
returnResponse(const oatpp::Object<LoadPluginDto>& body) {
    ...
    if (!m_moduleLoader->LoadModule(plugin_path, plugin_name)) {
        res->error = "ModuleError";
#if __cplusplus >= 202002L
        res->message = std::format("Failed to load module: {}", plugin_name);
#else
...
ENDPOINT_ASYNC("GET", "/api/module/unload", getUIUnloadModule){
    ENDPOINT_ASYNC_INIT(getUIUnloadModule) Action act()
        override{return request
                     ->readBodyToDtoAsync<oatpp::Object<UnloadPluginDto>>(
                         controller->getDefaultObjectMapper())
                     .callbackTo(&getUIUnloadModule::returnResponse);
}
...
ENDPOINT_INFO(getUIGetModuleList) {
    ...
    info->addResponse<Object<StatusDto>>(Status::CODE_200, "application/json");
    info->addResponse<Object<ReturnModuleListDto>>(Status::CODE_200,
                                                   "application/json");
}
ENDPOINT_ASYNC("GET", "/api/module/list", getUIGetModuleList){
    ENDPOINT_ASYNC_INIT(getUIGetModuleList) Action act()
        override{return request
                     ->readBodyToDtoAsync<oatpp::Object<GetModuleListDto>>(
                         controller->getDefaultObjectMapper())
                     .callbackTo(&getUIGetModuleList::returnResponse);
}
...
ENDPOINT_ASYNC("GET", "/api/module/refresh", getUIRefreshModuleLists){
    ENDPOINT_ASYNC_INIT(getUIRefreshModuleLists) Action act()
        override{return request
                     ->readBodyToDtoAsync<oatpp::Object<RefreshModuleListDto>>(
                         controller->getDefaultObjectMapper())
                     .callbackTo(&getUIRefreshModuleLists::returnResponse);
}
...
ENDPOINT_INFO(getUIEnableModule) {
    ...
    info->addResponse<Object<StatusDto>>(Status::CODE_200, "application/json");
    info->addResponse<Object<ReturnEnableModuleDto>>(Status::CODE_200,
                                                     "application/json");
}
ENDPOINT_ASYNC("GET", "/api/module/enable", getUIEnableModule){
    ENDPOINT_ASYNC_INIT(getUIEnableModule) Action act()
        override{return request
                     ->readBodyToDtoAsync<oatpp::Object<GetEnableModuleDto>>(
                         controller->getDefaultObjectMapper())
                     .callbackTo(&getUIEnableModule::returnResponse);
}
...
ENDPOINT_INFO(getUIDisableModule) {
    ...
    info->addResponse<Object<StatusDto>>(Status::CODE_200, "application/json");
    info->addResponse<Object<ReturnDisableModuleDto>>(Status::CODE_200,
                                                      "application/json");
}
ENDPOINT_ASYNC("GET", "/api/module/disable", getUIDisableModule){
    ENDPOINT_ASYNC_INIT(getUIDisableModule) Action act()
        override{return request
                     ->readBodyToDtoAsync<oatpp::Object<GetDisableModuleDto>>(
                         controller->getDefaultObjectMapper())
                     .callbackTo(&getUIDisableModule::returnResponse);
}
...
ENDPOINT_INFO(getUIGetModuleStatus) {
    ...
    info->addResponse<Object<StatusDto>>(Status::CODE_200, "application/json");
    info->addResponse<Object<ReturnModuleStatusDto>>(Status::CODE_200,
                                                     "application/json");
}
ENDPOINT_ASYNC("GET", "/api/module/status", getUIGetModuleStatus){
    ENDPOINT_ASYNC_INIT(getUIGetModuleStatus) Action act()
        override{return request
                     ->readBodyToDtoAsync<oatpp::Object<GetModuleStatusDto>>(
                         controller->getDefaultObjectMapper())
                     .callbackTo(&getUIGetModuleStatus::returnResponse);
}
...
Action returnResponse(const oatpp::Object<GetModuleStatusDto>& body) {
    ...
    if (module_status) {
        ...
        res->error = "ModuleError";
        res->message =
            fmt::format("Failed to get module status: {}", module_name);
    }
    return _return(controller->createDtoResponse(Status::CODE_200, res));
}
}
...
ENDPOINT_INFO(getUIGetModuleConfig) {
    ...
    info->addResponse<Object<StatusDto>>(Status::CODE_200, "application/json");
    info->addResponse<Object<ReturnModuleConfigDto>>(Status::CODE_200,
                                                     "application/json");
}
ENDPOINT_ASYNC("GET", "/api/module/config", getUIGetModuleConfig){
    ENDPOINT_ASYNC_INIT(getUIGetModuleConfig) Action act()
        override{return request
                     ->readBodyToDtoAsync<oatpp::Object<GetModuleConfigDto>>(
                         controller->getDefaultObjectMapper())
                     .callbackTo(&getUIGetModuleConfig::returnResponse);
}
...
Action returnResponse(const oatpp::Object<GetModuleConfigDto>& body) {
    ...
    if (!module_config.empty()) {
        ...
        res->error = "ModuleError";
        res->message =
            fmt::format("Failed to get module config: {}", module_name);
    }
    return _return(controller->createDtoResponse(Status::CODE_200, res));
}
}
...
ENDPOINT_INFO(getUIGetInstance) {
    info->summary =
        "Get shared_ptr from a specific module and register it into global ptr "
        "mamanger";
...
ENDPOINT_ASYNC("GET", "/api/module/get/instance", getUIGetInstance){
    ENDPOINT_ASYNC_INIT(getUIGetInstance) Action act()
        override{return request
                     ->readBodyToDtoAsync<oatpp::Object<GetInstanceDto>>(
                         controller->getDefaultObjectMapper())
                     .callbackTo(&getUIGetInstance::returnResponse);
}
...
#endif  // ASYNC_MODULE_CONTROLLER_HPP