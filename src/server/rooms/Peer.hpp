...
private:
    oatpp::async::CoroutineStarter onApiError(
        const oatpp::String& errorMessage);

private:
    oatpp::async::CoroutineStarter validateFilesList(
        const MessageDto::FilesList& filesList);
    oatpp::async::CoroutineStarter handleFilesMessage(
        const oatpp::Object<MessageDto>& message);
    oatpp::async::CoroutineStarter handleFileChunkMessage(
        const oatpp::Object<MessageDto>& message);

    oatpp::async::CoroutineStarter handleMessage(
        const oatpp::Object<MessageDto>& message);
