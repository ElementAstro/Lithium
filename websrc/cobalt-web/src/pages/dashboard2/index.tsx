...
import { Camera, Magic, ArrowsMove, Bullseye } from 'react-bootstrap-icons';
// svg
import { ReactComponent as PolarAlignSVG } from '../../icons/console/polar_align.svg';
import { ReactComponent as TelescopeControl } from '../../icons/console/telescope_control.svg';
import { ReactComponent as FilterControl } from '../../icons/console/filter.svg';
...
Registry.addComponent('align', Align, PolarAlignSVG);
Registry.addComponent('autofocus', Autofocus, Bullseye);

Registry.addComponent('camera', DeviceCameraSimpleControlPanel);
Registry.addComponent('telescope', DeviceTelescopeSimpleControlPanel, TelescopeControl);
Registry.addComponent('focuser', DeviceFocuserSimpleControlPanel);
Registry.addComponent('filter', DeviceFilterSimpleControlPanel, FilterControl);
Registry.addComponent('phd2', DevicePHD2SimpleControlPanel, GuideSVG);
        ...
        <>
            {
                ...
                (<img className='newest_image' src={process_data.newest_camera_jpg_url} style={{zIndex: 1}}></img>):
                (<img className='newest_image' src={process_data.newest_guider_jpg_url} style={{zIndex: 1}}></img>)
            }
