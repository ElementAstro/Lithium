      ...
      <div className="row">
        <div className="col-md-6">
          <Card className="p-3">
            <Row>
              <Col>
                <h4 className="mb-3">导星相机信息</h4>
                <h6 className="mb-3">设备型号: {device_name}</h6>
                <h6 className="mb-3">相机物理参数:</h6>
                <p className="mb-3">x像素数量: {camera_info.x_pixels}</p>
                <p className="mb-3">y像素数量: {camera_info.y_pixels}</p>
                <p className="mb-3">
        ...
        <div className="col-md-6">
          <Card className="p-3">
            <h4 className="mb-3">导星相机控制面板</h4>
            <div className="d-flex align-items-center mb-3">
              <ThermometerSnow />
              <h6 className="ml-2 mb-0">制冷控制</h6>
            </div>
                ...
                <div className="form-group my-3">
                  ...
                  <InputGroup className="mb-3">
                    ...
                    >
                      {control_cool_down ? (
                        <>
                          <Hourglass size={20} className="mr-1" />
                          等待中...
                        </>
                      ) : (
                        <>
