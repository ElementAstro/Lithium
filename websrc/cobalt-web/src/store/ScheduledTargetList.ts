...
function isFramingObject(target_info: IDSOFramingObjectInfo | IDSOObjectInfo): target_info is IDSOFramingObjectInfo {
...
export interface ISTargetListModels {
    ...
    update_focus_target_by_framing: Action<ISTargetListModels, IDSOFramingObjectInfo>;
...
export const ScheduledTargetListStore = ():ISTargetListModels =>({
    ...
    update_focus_target_by_framing: action((state, payload) => {  // note do not use, it is not tested and verified.
        state.current_focus_target = payload;
        state.need_focus = true;
    }),
    ...
    update_twilight_data: action((state, payload) => {
        state.twilight_data = {
            evening: {
                sun_set_time: DateTime.fromFormat(payload.evening.sun_set_time, 'yyyy-MM-dd HH:mm:ss').toJSDate(),
                evening_civil_time: DateTime.fromFormat(payload.evening.evening_civil_time, 'yyyy-MM-dd HH:mm:ss').toJSDate(),
                evening_nautical_time: DateTime.fromFormat(payload.evening.evening_nautical_time, 'yyyy-MM-dd HH:mm:ss').toJSDate(),
                evening_astro_time: DateTime.fromFormat(payload.evening.evening_astro_time, 'yyyy-MM-dd HH:mm:ss').toJSDate(),
            },
            morning: {
                sun_rise_time: DateTime.fromFormat(payload.morning.sun_rise_time, 'yyyy-MM-dd HH:mm:ss').toJSDate(),
                morning_civil_time: DateTime.fromFormat(payload.morning.morning_civil_time, 'yyyy-MM-dd HH:mm:ss').toJSDate(),
                morning_nautical_time: DateTime.fromFormat(payload.morning.morning_nautical_time, 'yyyy-MM-dd HH:mm:ss').toJSDate(),
                morning_astro_time: DateTime.fromFormat(payload.morning.morning_astro_time, 'yyyy-MM-dd HH:mm:ss').toJSDate(),
            }
        }
    }),
