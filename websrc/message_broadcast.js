...
const clientRoutes = new Map(); // Tracks which routes clients are subscribed to
const authenticatedClients = new Set(); // Tracks clients that have successfully authenticated
const groupMembers = new Map(); // Tracks clients in various groups
...
wss.on("connection", (ws) => {
  ...
  let clientGroups = new Set(); // Client's group memberships
...
function multicastMessage(route, message) {
  wss.clients.forEach((client) => {
