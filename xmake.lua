...
target("Lithium")
    ...
    add_files(
        ...
        "$(lithium_src_dir)/api/hydrogenclient.cpp",
        "$(lithium_src_dir)/api/hydrogenclient.hpp",
        ...
        "$(lithium_src_dir)/modules/module/module_loader.cpp",
        "$(lithium_src_dir)/modules/module/module_loader.hpp",
